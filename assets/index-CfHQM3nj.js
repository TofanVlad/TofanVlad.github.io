...
`;function Cy(n){const e=n.offsetWidth,t=n.offsetHeight,i=new ma,r=new Yt(65,e/t);r.position.z=8.5,r.position.y=1.5,r.rotation.x=.2,i.add(r);const s=new pa({canvas:n,alpha:!0});s.setSize(e,t);const o=on({uTime:{value:0},uAmplitude:{value:.25},uWaveLength:{value:1}}),a=new Is(32,12,64,8),l=new Kn({vertexShader:wy,fragmentShader:Ry,wireframe:!0,uniforms:o.value}),c=new bn(a,l);c.rotation.y=Math.PI/180*180,c.rotation.x=Math.PI/180*90,i.add(c);function u(){o.value.uTime.value+=.025,s.render(i,r),requestAnimationFrame(u)}window.addEventListener("resize",()=>{n.style.width="100vw",n.style.height="100vh";const f=n.offsetWidth,h=n.offsetHeight;r.aspect=f/h,r.updateProjectionMatrix(),s.setPixelRatio(window.devicePixelRatio),s.setSize(f,h),s.render(i,r)}),u()}const Ly={class:"flex lg:flex-row flex-col justify-between lg:items-center lg:gap-8 gap-4 xl:mt-24 sm:mt-8 mt-0"},Py={class:"flex flex-col gap-2 px-8"},Iy={class:"sm:text-sm text-xs tracking-widest"},Ny={class:"md:text-2xl sm:text-2xl text-base tracking-widest uppercase"},Dy={class:"flex lg:flex-row flex-col justify-between lg:items-center lg:gap-8 gap-4 bg-[#0e0e0e]/50 pb-4"},Uy={class:"flex flex-col gap-2 lg:whitespace-nowrap px-8"},Oy={class:"sm:text-sm text-xs tracking-widest"},Fy=le("h1",{class:"md:text-[46px] sm:text-4xl text-2xl"},[At(" Frontend Developer"),le("br",{class:"lg:block hidden"}),At(" TweenyOne SRL "),le("br"),At(" 2023 - 2024 ")],-1),By=le("h1",{class:"md:text-[46px] sm:text-4xl text-2xl mt-4"},[At(" Frontend Developer"),le("br",{class:"lg:block hidden"}),At(" Triseidon SRL "),le("br"),At(" 2024 - 2025 ")],-1),ky={class:"lg:border-l-2 lg:border-t-0 flex-col border-t-2 border-white h-full md:text-3xl sm:text-xl text-lg lg:mx-0 mx-8 lg:py-0 lg:px-4 pt-4 tracking-widest flex"},Hy={class:"my-auto"},zy={class:"my-auto mt-4"},Vy=It({__name:"my-about",setup(n){const e=on(null);return ir(()=>{e.value!==null&&Cy(e.value)}),(t,i)=>(ct(),wt(pt,null,[Qe(Uo,{class:"flex flex-col md:pt-28 pt-24 pb-16 z-10 relative lg:gap-16 gap-8 uppercase"},{default:Mi(()=>[le("div",Ly,[le("div",Py,[le("p",Iy,Ye(t.$t("about.title")),1),le("h1",Ny,Ye(t.$t("about.title_desc")),1)])]),le("div",Dy,[le("div",Uy,[le("p",Oy,Ye(t.$t("about.exp")),1),Fy,By]),le("div",ky,[le("p",Hy,Ye(t.$t("about.exp_desc")),1),le("p",zy,Ye(t.$t("about.exp_desc2")),1)])])]),_:1}),le("canvas",{ref_key:"canvas",ref:e,class:"w-screen h-screen absolute top-0 left-0"},null,512)],64))}}),yp=n=>(ia("data-v-5494b4bb"),n=n(),ra(),n),Gy=["href"],Wy=yp(()=>le("div",{class:"-translate-x-[110%] absolute left-0 bottom-0 transition-transform w-full"},"+",-1)),Xy=yp(()=>le("div",{class:"absolute bottom-0 left-0 w-full h-[1px] bg-white -translate-x-[110%] transition-transform"},null,-1)),$y={class:"tracking-widest"},Yy=It({__name:"my-link",props:{href:{},text:{}},setup(n){return(e,t)=>e.href?(ct(),wt("a",{key:0,href:e.href,target:"_blank",class:"items-center flex gap-2 relative w-max group md:hover:pl-4 hover:pl-3 transition-[padding] overflow-hidden md:text-[.8vw] text-[12px] lg:text-sm md:text-xs link"},[Wy,Xy,le("p",$y,Ye(e.text),1)],8,Gy)):_c("",!0)}}),_a=(n,e)=>{const t=n.__vccOpts||n;for(const[i,r]of e)t[i]=r;return t},Ao=_a(Yy,[["__scopeId","data-v-5494b4bb"]]),qy={class:"outline-1 outline md:outline-white/50 transition-[colors_outline] duration-300 md:group-hover:outline-green-500 md:group-hover:text-green-500 md:text-white/50 text-green-500 lg:px-3 px-2 md:py-1 py-[2px] rounded lg:text-sm md:text-xs text-[12px] md:leading-none"},jy=It({__name:"my-chip",props:{text:{}},setup(n){return(e,t)=>(ct(),wt("div",qy,Ye(e.text),1))}}),Ky={class:"xl:flex md:hidden flex gap-2 md:group-hover:text-white md:group-hover:translate-x-0 md:text-white/50 transition-[colors_translate] duration-300 sm:mt-4 mt-4 col-span-3 md:group-hover:opacity-100 md:-translate-x-[50px] md:opacity-0 sm:text-[2.2vw] text-[3vw] md:text-sm tracking-[.1vw]"},Jy=le("div",null,"+",-1),Zy=It({__name:"my-description",props:{text:{}},setup(n){return(e,t)=>(ct(),wt("p",Ky,[Jy,At(" "+Ye(e.text[e.$i18n.locale]),1)]))}}),Qy={class:"flex flex-col gap-2 mt-4 overflow-hidden tracking-wide md:mt-0 lg:gap-2 md:gap-1"},eT={class:"text-base tracking-widest xl:text-sm"},tT={class:"lg:text-4xl md:text-[4vw] text-[6vw] leading-none"},nT={class:"text-base tracking-widest xl:text-sm"},iT={class:"lg:text-4xl md:text-[4vw] text-[6vw] leading-none"},rT={class:"text-base tracking-widest xl:text-sm"},sT={class:"flex flex-wrap gap-2 pb-1 pl-1 mt-2"},oT=It({__name:"my-card-desc",props:{title:{},year:{},tehnologies:{},description:{},role:{}},setup(n){return(e,t)=>(ct(),wt("div",Qy,[le("div",null,[le("p",eT,Ye(e.$t("card.year")),1),le("h2",tT,Ye(e.year),1)]),le("div",null,[le("p",nT,Ye(e.$t("card.role")),1),le("h2",iT,Ye(e.role?e.role:"FRONTEND DEVELOPER"),1)]),le("div",null,[le("p",rT,Ye(e.$t("card.tehnologies")),1),le("div",sT,[(ct(!0),wt(pt,null,aa(e.tehnologies,(i,r)=>(ct(),rr(jy,{key:r,text:i},null,8,["text"]))),128))])]),Qe(Zy,{text:e.description},null,8,["text"])]))}}),aT={class:"border-t-[1px] border-white md:grid flex flex-col xl:grid-cols-[1.5fr_5fr_3fr] grid-cols-[1fr_5.5fr_3fr] w-full mb-20 uppercase relative group transition-colors duration-300 hover:text-white md:text-[white]/50"},lT={class:"px-[1.5vw] pt-[1.5vw] xl:px-4 xl:pt-4 md:block hidden"},cT={class:"xl:text-lg text-[1.2vw] tracking-widest"},uT={class:"xl:text-[90px] text-[5.5vw] leading-none"},fT={class:"pt-[1.5vw] md:px-4 xl:pt-4 relative aspect-video md:border-x-[1px] border-white"},hT=le("div",{class:"absolute top-0 left-0 w-full h-full transition-colors duration-300 md:bg-black/50 group-hover:bg-transparent"},null,-1),dT=["src","alt"],pT={class:"px-[1.5vw] pt-[1.5vw] xl:px-4 xl:pt-4"},mT=It({__name:"my-card",props:{project:{}},setup(n){return(e,t)=>(ct(),wt("article",aT,[le("div",lT,[le("p",cT,Ye(e.project.title[e.$i18n.locale]),1),le("h1",uT," 0"+Ye(e.project.number),1),Qe(Ao,{href:e.project.href,text:e.$t("card.visit")},null,8,["href","text"])]),le("div",fT,[hT,le("img",{src:e.project.video,alt:e.project.title[e.$i18n.locale],class:"object-cover w-full h-full"},null,8,dT)]),le("div",pT,[Qe(oT,{title:e.project.title,year:e.project.year,description:e.project.description,tehnologies:e.project.tehnologies,role:e.project.role},null,8,["title","year","description","tehnologies","role"])])]))}}),_T="/logo-removebg.png",wo=on(!1);function Xo(){window.innerWidth<768&&(wo.value=!wo.value),wo.value?document.body.style.overflowY="hidden":document.body.style.overflowY="auto"}const gT=n=>(ia("data-v-4652c147"),n=n(),ra(),n),vT={class:"flex items-center gap-8 justify-between fixed top-4 left-1/2 -translate-x-1/2 w-full max-w-[1240px] px-8 z-[999]"},xT=gT(()=>le("div",{class:"md:w-[75px] w-[45px] aspect-square"},[le("img",{src:_T,alt:"Logo",class:"w-full h-full object-contain"})],-1)),ET={class:"md:hidden block text-lg tracking-widest"},ST={class:"md:flex hidden items-center gap-4"},MT={href:"#home",class:"relative before:absolute before:bottom-0 before:left-0 before:w-0 hover:before:w-full before:h-[2px] before:bg-white before:transition-all before:duration-300"},yT={href:"#about",class:"relative before:absolute before:bottom-0 before:left-0 before:w-0 hover:before:w-full before:h-[2px] before:bg-white before:transition-all before:duration-300"},TT={href:"#projects",class:"relative before:absolute before:bottom-0 before:left-0 before:w-0 hover:before:w-full before:h-[2px] before:bg-white before:transition-all before:duration-300"},bT={href:"#contacts",class:"relative before:absolute before:bottom-0 before:left-0 before:w-0 hover:before:w-full before:h-[2px] before:bg-white before:transition-all before:duration-300"},AT={class:"outline outline-[1px] outline-white flex h-max relative bg-[#0e0e0e]/75"},wT=It({__name:"my-nav",setup(n){return(e,t)=>(ct(),wt("nav",vT,[le("div",{class:"md:px-4 px-2 outline outline-1 outline-white bg-[#0e0e0e]/75 flex items-center md:cursor-auto cursor-pointer justify-between gap-4 uppercase top-8 md:w-[650px]",onClick:t[0]||(t[0]=(...i)=>gi(Xo)&&gi(Xo)(...i))},[xT,le("p",ET,Ye(e.$t("nav.menu")),1),le("ul",ST,[le("a",MT,Ye(e.$t("nav.home")),1),le("a",yT,Ye(e.$t("nav.about")),1),le("a",TT,Ye(e.$t("nav.projects")),1),le("a",bT,Ye(e.$t("nav.contacts")),1)])]),le("div",AT,[le("div",{class:"py-1 px-2 cursor-pointer text-black invert-[1] mix-blend-difference font-medium z-[5]",onClick:t[1]||(t[1]=i=>e.$i18n.locale="en")}," EN "),le("div",{class:"py-1 px-2 cursor-pointer text-black invert-[1] mix-blend-difference font-medium z-[5]",onClick:t[2]||(t[2]=i=>e.$i18n.locale="ro")}," RO "),le("div",{class:ys(["absolute w-1/2 h-full bg-white top-0 transition-all",e.$i18n.locale==="en"?"translate-x-0":"translate-x-[calc(100%+1px)]"])},null,2)])]))}}),RT=_a(wT,[["__scopeId","data-v-4652c147"]]),CT={key:0,class:"w-screen h-[100dvh] bg-[#090909] bottom-0 left-0 md:hidden flex flex-col fixed px-4 pt-20 z-[100]"},LT={class:"uppercase text-2xl mt-20"},PT=le("br",null,null,-1),IT={class:"flex flex-col my-auto divide-y-2"},NT=["href"],DT={class:"text-4xl"},UT={class:"text-xs"},OT=le("hr",{class:"mt-auto"},null,-1),FT=le("div",{class:"flex items-center justify-between mb-4 py-2"},[le("a",{href:"mailto:tofanvladit@gmail.com "},"E-MAIL"),le("a",{href:"https://www.linkedin.com/in/vlad-tofan-349b70291/"},"LINKEDIN"),le("a",{href:"https://discordapp.com/users/284386100829487106"},"DISCORD"),le("a",{href:"https://github.com/TofanVlad"},"GITHUB")],-1),BT=It({__name:"my-menu",setup(n){const e=[{title:"nav.home",href:"#home"},{title:"nav.about",href:"#about"},{title:"nav.projects",href:"#projects"},{title:"nav.contacts",href:"#contacts"}];return(t,i)=>(ct(),rr(ca,{name:"slide-fade"},{default:Mi(()=>[gi(wo)?(ct(),wt("section",CT,[le("h1",LT,[At(Ye(t.$t("header.welcome_1"))+" ",1),PT,At(" "+Ye(t.$t("header.welcome_2")),1)]),le("div",IT,[(ct(),wt(pt,null,aa(e,(r,s)=>le("a",{href:r.href,key:s,class:"uppercase py-4 cursor-pointer flex gap-2",onClick:i[0]||(i[0]=(...o)=>gi(Xo)&&gi(Xo)(...o))},[le("p",DT,Ye(t.$t(r.title)),1),le("p",UT,"0"+Ye(s+1),1)],8,NT)),64))]),OT,FT])):_c("",!0)]),_:1}))}}),kT="/Me.jpg";function HT(n){const e=n.offsetWidth,t=n.offsetHeight,i=new ma,r=new Yt(65,e/t);r.position.z=14,r.position.y=3,i.add(r);const s=new pa({canvas:n,alpha:!0});s.setSize(e,t);const o=new Mp,a=new py(16777215,1.5);i.add(a);const l=m=>{const g=new Float32Array(m*3);for(let x=0;x<m;x++)g[x]=(Math.random()-.5)*500;return g},c=new tn;c.setAttribute("position",new mn(l(3e3),3));const u=new Go({size:.05,map:o.load("/star.png"),transparent:!0}),f=new Vl(c,u);i.add(f);function h(){f.rotation.y-=1e-4,s.render(i,r),requestAnimationFrame(h)}window.addEventListener("resize",()=>{n.style.width="100vw",n.style.height="100vh";const m=n.offsetWidth,g=n.offsetHeight;r.aspect=m/g,r.updateProjectionMatrix(),s.setPixelRatio(window.devicePixelRatio),s.setSize(m,g),s.render(i,r)}),h()}const Tp=n=>(ia("data-v-222630c4"),n=n(),ra(),n),zT=Tp(()=>le("div",{class:"aspect-[4/5] md:max-h-[455px] max-h-[350px]"},[le("img",{src:kT,alt:"Tofan Vlad - Profile Picture",class:"w-full h-full object-contain md:max-h-[615px] max-h-[350px]"})],-1)),VT={class:"text-[#0e0e0e] bg-white px-8 py-4 lg:text-[3.6vw] md:text-5xl sm:text-[6.2vw] text-[5.6vw] text-center"},GT={class:"flex flex-col lg:w-[50%] w-[75%] gap-2"},WT={class:"w-full border-b-[1px] border-white text-center lg:text-[1.6vw] text-2xl"},XT={class:"grid grid-cols-3 gap-8"},$T=Tp(()=>le("a",{href:"mailto:tofanvladit@gmail.com",class:"lg:text-[3.6vw] text-4xl h-max lg:leading-[3.6vw] tracking-widest overflow-hidden relative before:bottom-0 before:-left-full before:absolute before:content-[''] before:bg-white before:h-[2px] before:w-full hover:before:translate-x-full before:transition-transform"},[At(" TOFANVLADIT"),le("br",{class:"block md:hidden"}),At("@GMAIL.COM")],-1)),YT=It({__name:"my-footer",setup(n){const e=on(null);return ir(()=>{e.value!==null&&HT(e.value)}),(t,i)=>(ct(),wt(pt,null,[le("canvas",{ref_key:"canvas",ref:e,class:"absolute top-0 left-0 w-screen h-screen pointer-events-none"},null,512),Qe(Uo,{class:"flex flex-col items-center justify-around pt-24 pb-12 md:pt-34 md:pb-0"},{default:Mi(()=>[zT,le("div",VT," + "+Ye(t.$t("footer.title")),1),le("div",GT,[le("p",WT,Ye(t.$t("footer.connect")),1),le("div",XT,[Qe(Ao,{text:"GITHUB",href:"https://github.com/TofanVlad"}),Qe(Ao,{text:"LINKEDIN",href:"https://www.linkedin.com/in/vlad-tofan-349b70291/",class:"place-self-center"}),Qe(Ao,{text:"DISCORD",href:"https://discordapp.com/users/284386100829487106",class:"place-self-end"})])]),$T]),_:1})],64))}}),qT=_a(YT,[["__scopeId","data-v-222630c4"]]),Ro=[10.136184463414924,-1.374508746897471,10.384881573913269,9.115259388985471,-1.374508746897471,8.584679279757001,9.066935570975488,-1.0665123466336568,5.893777163160816,10.151040177840205,-.6591365314493796,3.4340491740541346,10.806779203170416,1.8859391007298545,.46855774212986023,10.761433540147586,2.8724172201359197,-1.2811838605587311,9.619592310444506,2.8724172201359197,-3.2833099941904766,6.976302088915165,2.7659257976905427,-4.759195890883017,6.04612778913537,1.072704530208988,-6.663874016409048,7.347223577854479,-1.8228856326635698,-9.068504304618562,7.226367212900791,-1.8228856326635698,-10.499536640855691,5.835456669626391,-1.8228856326635698,-12.039219379199908,3.6532357452141353,-.2046398357057339,-13.87695442281038,-.30169589630131455,1.5965000671484342,-14.879986418947327,-2.8925694230502157,2.297136461442748,-13.892095587598131,-4.537672295357936,4.586351575965921,-12.140831652074551,-6.128791346411759,5.9653814634119815,-8.97765273188759,-6.012030160645281,4.4081161943856,-6.712084358394045,-5.213825215903897,2.820894808418279,-4.453282041208561,-2.342471283510961,2.203206500508626,-3.0788773693500198,-.0076956453915433265,1.8931797788880202,-1.6577070662471063,-.24767503988481437,2.8845808465856684,.07391585921422172,-2.2174044353598896,4.241552450731858,2.215992718290742,-3.4526531678364756,3.061519202334085,4.792240493209656,-3.7356278971556445,1.4054080369354316,7.843202184143463,-3.400373446380412,1.1924069108769393,9.246409088622707,-1.8851803760476225,1.5269331003449989,10.306083896408374,.01071077144031829,2.1101821577522295,10.490880699847727,.42562058195647,2.2759939598834387,11.61312943658029,.09640526218222512,.03231778408405439,16.223455375061565,2.3458797884520433,.38907275257695584,19.91188266079584,5.701840009848877,1.73337964747396,20.61548158699996,7.972093973675182,1.73337964747396,19.303399329816457,9.867236272109565,.09008301805702518,16.89333854161812,11.225959519544134,-1.374508746897471,14.279002555560753,11.288646925965876,-1.374508746897471,11.926359497447137,10.136184463414924,-1.374508746897471,10.384881573913269],bp=[],jT=Ro.length;for(let n=0;n<jT;n+=3)bp.push(new z(Ro[n],Ro[n+1],Ro[n+2]));const ih=new Ep(bp);function KT(n){const e=n.offsetWidth,t=n.offsetHeight,i=new ma;i.fog=new bc(921102,.5);const r=new Yt(65,e/t);r.position.z=14,r.position.y=3,i.add(r);const s=new pa({canvas:n,alpha:!0});s.setSize(e,t);const o=.5,a=new Wo(ih,256,o,16,!0),l=new cy(a,.25),c=new vp({color:16777215}),u=new YM(l,c);i.add(u);const f=new Wo(ih,256,o+.01,16,!0),h=new yc({color:921102,side:qt}),m=new bn(f,h);i.add(m);function g(_){const p=_*.05,R=10*1e3,v=p%R/R,S=a.parameters.path.getPointAt(v),P=a.parameters.path.getPointAt((v+.025)%1);r.position.copy(S),r.lookAt(P)}function x(_=0){g(_),s.render(i,r),requestAnimationFrame(x)}window.addEventListener("resize",()=>{n.style.width="100%",n.style.height="100%";const _=n.offsetWidth,p=n.offsetHeight;r.aspect=_/p,r.updateProjectionMatrix(),s.setPixelRatio(window.devicePixelRatio),s.setSize(_,p),s.render(i,r)}),x()}const JT=["Vue JS","Nuxt JS","Tailwind CSS","Three JS","API","SwiperJS","Typescript","git","SEO"],ZT=[{title:{en:"Tehnoconduct",ro:"Tehnoconduct"},href:"https://tehnoconduct.md",year:2024,tehnologies:["Nuxt","Tailwind","Typescript","api"],description:{en:"Built out the frontend for tehnoconduct.md from scratch. implemented animations to enrich user experience.",ro:"Am creat frontend-ul pentru tehnoconduct.md de la zero, de asemenea am implementat animații pentru a îmbogăți experiența utilizatorului."},video:"/images/Tehnoconduct.png"},{title:{en:"Sushi",ro:"Sushi"},year:2023,href:"https://github.com/TofanVlad/Sushi",role:"FullStack DEVELOPER",tehnologies:["Vue","Typescript","api","scss"],description:{en:"My very first full-stack project that I did on my own. Implemented responsive design along with various modals.",ro:"Primul meu proiect full-stack pe care l-am făcut pe cont propriu. Am implementat design responsive împreună cu diverse funcționalități."},video:"/images/Sushi.png"},{href:"https://github.com/TofanVlad/Minesweeper",title:{en:"Minesweeper",ro:"Minesweeper"},year:2024,tehnologies:["Vue","Typescript","TailwindCSS"],description:{en:"In this project I recreated the popular game Minesweeper.",ro:"În acest proiect am recreat jocul popular Minesweeper."},video:"/images/MineSweeper.png"},{href:"https://github.com/TofanVlad/innete",title:{en:"Inette",ro:"Inette"},year:2024,tehnologies:["Vue","Typescript","TailwindCSS","AnimeJS"],description:{en:"This project is replica of real web-site inette.co.",ro:"Acest proiect este replica unui web-site real inette.co."},video:"/images/Inette.png"},{href:"https://www.arhiterra.md/ro/",title:{en:"ARHITERRA",ro:"ARHITERRA"},year:2025,tehnologies:["Nuxt","Typescript","TailwindCSS","SwiperJS"],description:{en:"Comercial project of a architecture company.",ro:"Proiect comercial a unei companii de arhitectură."},video:"/images/ARHITERRA.png"}],QT=It({__name:"my-cell",props:{text:{},index:{}},setup(n){return(e,t)=>(ct(),wt("div",{class:ys(["border-[1px] border-white bg-black/75 flex items-center justify-center lg:text-[2.2vw] sm:text-xl font-light tracking-wider uppercase",e.index===0&&"lg:col-span-1 col-span-2"])},[le("p",null,Ye(e.text),1)],2))}}),eb=n=>(ia("data-v-c126a216"),n=n(),ra(),n),tb={class:"mt-32 justify-end items-center uppercase flex gap-2 xl:px-0 px-2 tracking-widest"},nb=eb(()=>le("span",{class:"text-lg"},"+",-1)),ib={class:"w-full h-[450px] border-[1px] border-white relative"},rb={key:0,class:"w-full h-full absolute top-0 left-0 grid lg:grid-cols-3 grid-cols-2 sm:p-8 p-4 lg:gap-8 gap-4 bg-black/50"},sb=It({__name:"my-stack",setup(n){const e=on(null),t=on(!0);return ir(()=>{e.value!==null&&KT(e.value)}),(i,r)=>(ct(),wt(pt,null,[le("p",tb,[nb,At(" "+Ye(i.$t("stack.title")),1)]),le("section",ib,[le("canvas",{ref_key:"canvas",ref:e,class:"w-full h-full"},null,512),Qe(ca,null,{default:Mi(()=>[t.value?(ct(),wt("div",rb,[(ct(!0),wt(pt,null,aa(gi(JT),(s,o)=>(ct(),rr(QT,{key:o,text:s,index:o},null,8,["text","index"]))),128))])):_c("",!0)]),_:1})]),le("button",{onClick:r[0]||(r[0]=s=>t.value=!t.value),class:"lg:text-[1.6vw] text-lg leading-none tracking-widest bg-transparent hover:bg-white border-[1px] border-white transition-colors px-4 py-2 hover:text-[#0e0e0e] text-white mb-32 mx-auto mt-4 w-max block"},Ye(t.value?i.$t("stack.button_hide"):i.$t("stack.button_show"))+" "+Ye(i.$t("stack.button")),1)],64))}}),ob=_a(sb,[["__scopeId","data-v-c126a216"]]),ab=le("hr",{class:"mx-4 my-8"},null,-1),lb={class:"relative",id:"about"},cb=le("hr",{class:"mb-16"},null,-1),ub={class:"justify-end items-center uppercase flex gap-2 xl:px-0 px-2 tracking-widest"},fb=le("span",{class:"text-lg"},"+",-1),hb=le("hr",{class:"mb-16"},null,-1),db={class:"relative",id:"contacts"},pb=It({__name:"App",setup(n){return(e,t)=>(ct(),wt(pt,null,[Qe(Uo,{tag:"header",id:"home"},{default:Mi(()=>[Qe(RT),Qe(Ay),Qe(BT,{"show-menu":!0})]),_:1}),ab,le("main",lb,[Qe(Vy)]),cb,Qe(Uo,{id:"projects",class:"md:pt-44 pt-24"},{default:Mi(()=>[le("p",ub,[fb,At(" "+Ye(e.$t("card.selected")),1)]),(ct(!0),wt(pt,null,aa(gi(ZT),(i,r)=>(ct(),rr(mT,{key:r,project:{...i,number:r+1}},null,8,["project"]))),128)),Qe(ob)]),_:1}),hb,le("footer",db,[Qe(qT)])],64))}});/*!
  * shared v9.13.1
  * (c) 2024 kazuya kawaguchi
  * Released under the MIT License.
  */const $o=typeof window<"u",Li=(n,e=!1)=>e?Symbol.for(n):Symbol(n),mb=(n,e,t)=>_b({l:n,k:e,s:t}),_b=n=>JSON.stringify(n).replace(/\u2028/g,"\\u2028").replace(/\u2029/g,"\\u2029").replace(/\u0027/g,"\\u0027"),St=n=>typeof n=="number"&&isFinite(n),gb=n=>wp(n)==="[object Date]",Ai=n=>wp(n)==="[object RegExp]",ga=n=>Oe(n)&&Object.keys(n).length===0,Pt=Object.assign;let rh;const $n=()=>rh||(rh=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function sh(n){return n.replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&apos;")}const vb=Object.prototype.hasOwnProperty;function Yo(n,e){return vb.call(n,e)}const ut=Array.isArray,ot=n=>typeof n=="function",ve=n=>typeof n=="string",$e=n=>typeof n=="boolean",it=n=>n!==null&&typeof n=="object",xb=n=>it(n)&&ot(n.then)&&ot(n.catch),Ap=Object.prototype.toString,wp=n=>Ap.call(n),Oe=n=>{if(!it(n))return!1;const e=Object.getPrototypeOf(n);return e===null||e.constructor===Object},Eb=n=>n==null?"":ut(n)||Oe(n)&&n.toString===Ap?JSON.stringify(n,null,2):String(n);function Sb(n,e=""){return n.reduce((t,i,r)=>r===0?t+i:t+e+i,"")}function va(n){let e=n;return()=>++e}function Mb(n,e){typeof console<"u"&&(console.warn("[intlify] "+n),e&&console.warn(e.stack))}const Eo=n=>!it(n)||ut(n);function Co(n,e){if(Eo(n)||Eo(e))throw new Error("Invalid value");const t=[{src:n,des:e}];for(;t.length;){const{src:i,des:r}=t.pop();Object.keys(i).forEach(s=>{Eo(i[s])||Eo(r[s])?r[s]=i[s]:t.push({src:i[s],des:r[s]})})}}/*!
  * message-compiler v9.13.1
  * (c) 2024 kazuya kawaguchi
  * Released under the MIT License.
  */function yb(n,e,t){return{line:n,column:e,offset:t}}function qo(n,e,t){return{start:n,end:e}}const Tb=/\{([0-9a-zA-Z]+)\}/g;function Rp(n,...e){return e.length===1&&bb(e[0])&&(e=e[0]),(!e||!e.hasOwnProperty)&&(e={}),n.replace(Tb,(t,i)=>e.hasOwnProperty(i)?e[i]:"")}const Cp=Object.assign,oh=n=>typeof n=="string",bb=n=>n!==null&&typeof n=="object";function Lp(n,e=""){return n.reduce((t,i,r)=>r===0?t+i:t+e+i,"")}const Cc={USE_MODULO_SYNTAX:1,__EXTEND_POINT__:2},Ab={[Cc.USE_MODULO_SYNTAX]:"Use modulo before '{{0}}'."};function wb(n,e,...t){const i=Rp(Ab[n],...t||[]),r={message:String(i),code:n};return e&&(r.location=e),r}const Le={EXPECTED_TOKEN:1,INVALID_TOKEN_IN_PLACEHOLDER:2,UNTERMINATED_SINGLE_QUOTE_IN_PLACEHOLDER:3,UNKNOWN_ESCAPE_SEQUENCE:4,INVALID_UNICODE_ESCAPE_SEQUENCE:5,UNBALANCED_CLOSING_BRACE:6,UNTERMINATED_CLOSING_BRACE:7,EMPTY_PLACEHOLDER:8,NOT_ALLOW_NEST_PLACEHOLDER:9,INVALID_LINKED_FORMAT:10,MUST_HAVE_MESSAGES_IN_PLURAL:11,UNEXPECTED_EMPTY_LINKED_MODIFIER:12,UNEXPECTED_EMPTY_LINKED_KEY:13,UNEXPECTED_LEXICAL_ANALYSIS:14,UNHANDLED_CODEGEN_NODE_TYPE:15,UNHANDLED_MINIFIER_NODE_TYPE:16,__EXTEND_POINT__:17},Rb={[Le.EXPECTED_TOKEN]:"Expected token: '{0}'",[Le.INVALID_TOKEN_IN_PLACEHOLDER]:"Invalid token in placeholder: '{0}'",[Le.UNTERMINATED_SINGLE_QUOTE_IN_PLACEHOLDER]:"Unterminated single quote in placeholder",[Le.UNKNOWN_ESCAPE_SEQUENCE]:"Unknown escape sequence: \\{0}",[Le.INVALID_UNICODE_ESCAPE_SEQUENCE]:"Invalid unicode escape sequence: {0}",[Le.UNBALANCED_CLOSING_BRACE]:"Unbalanced closing brace",[Le.UNTERMINATED_CLOSING_BRACE]:"Unterminated closing brace",[Le.EMPTY_PLACEHOLDER]:"Empty placeholder",[Le.NOT_ALLOW_NEST_PLACEHOLDER]:"Not allowed nest placeholder",[Le.INVALID_LINKED_FORMAT]:"Invalid linked format",[Le.MUST_HAVE_MESSAGES_IN_PLURAL]:"Plural must have messages",[Le.UNEXPECTED_EMPTY_LINKED_MODIFIER]:"Unexpected empty linked modifier",[Le.UNEXPECTED_EMPTY_LINKED_KEY]:"Unexpected empty linked key",[Le.UNEXPECTED_LEXICAL_ANALYSIS]:"Unexpected lexical analysis in token: '{0}'",[Le.UNHANDLED_CODEGEN_NODE_TYPE]:"unhandled codegen node type: '{0}'",[Le.UNHANDLED_MINIFIER_NODE_TYPE]:"unhandled mimifier node type: '{0}'"};function Xr(n,e,t={}){const{domain:i,messages:r,args:s}=t,o=Rp((r||Rb)[n]||"",...s||[]),a=new SyntaxError(String(o));return a.code=n,e&&(a.location=e),a.domain=i,a}function Cb(n){throw n}const Vn=" ",Lb="\r",$t=`
`,Pb="\u2028",Ib="\u2029";function Nb(n){const e=n;let t=0,i=1,r=1,s=0;const o=L=>e[L]===Lb&&e[L+1]===$t,a=L=>e[L]===$t,l=L=>e[L]===Ib,c=L=>e[L]===Pb,u=L=>o(L)||a(L)||l(L)||c(L),f=()=>t,h=()=>i,m=()=>r,g=()=>s,x=L=>o(L)||l(L)||c(L)?$t:e[L],_=()=>x(t),p=()=>x(t+s);function R(){return s=0,u(t)&&(i++,r=0),o(t)&&t++,t++,r++,e[t]}function v(){return o(t+s)&&s++,s++,e[t+s]}function S(){t=0,i=1,r=1,s=0}function P(L=0){s=L}function T(){const L=t+s;for(;L!==t;)R();s=0}return{index:f,line:h,column:m,peekOffset:g,charAt:x,currentChar:_,currentPeek:p,next:R,peek:v,reset:S,resetPeek:P,skipToPeek:T}}const ci=void 0,Db=".",ah="'",Ub="tokenizer";function Ob(n,e={}){const t=e.location!==!1,i=Nb(n),r=()=>i.index(),s=()=>yb(i.line(),i.column(),i.index()),o=s(),a=r(),l={currentType:14,offset:a,startLoc:o,endLoc:o,lastType:14,lastOffset:a,lastStartLoc:o,lastEndLoc:o,braceNest:0,inLinked:!1,text:""},c=()=>l,{onError:u}=e;function f(d,E,w,...U){const G=c();if(E.column+=w,E.offset+=w,u){const Y=t?qo(G.startLoc,E):null,N=Xr(d,Y,{domain:Ub,args:U});u(N)}}function h(d,E,w){d.endLoc=s(),d.currentType=E;const U={type:E};return t&&(U.loc=qo(d.startLoc,d.endLoc)),w!=null&&(U.value=w),U}const m=d=>h(d,14);function g(d,E){return d.currentChar()===E?(d.next(),E):(f(Le.EXPECTED_TOKEN,s(),0,E),"")}function x(d){let E="";for(;d.currentPeek()===Vn||d.currentPeek()===$t;)E+=d.currentPeek(),d.peek();return E}function _(d){const E=x(d);return d.skipToPeek(),E}function p(d){if(d===ci)return!1;const E=d.charCodeAt(0);return E>=97&&E<=122||E>=65&&E<=90||E===95}function R(d){if(d===ci)return!1;const E=d.charCodeAt(0);return E>=48&&E<=57}function v(d,E){const{currentType:w}=E;if(w!==2)return!1;x(d);const U=p(d.currentPeek());return d.resetPeek(),U}function S(d,E){const{currentType:w}=E;if(w!==2)return!1;x(d);const U=d.currentPeek()==="-"?d.peek():d.currentPeek(),G=R(U);return d.resetPeek(),G}function P(d,E){const{currentType:w}=E;if(w!==2)return!1;x(d);const U=d.currentPeek()===ah;return d.resetPeek(),U}function T(d,E){const{currentType:w}=E;if(w!==8)return!1;x(d);const U=d.currentPeek()===".";return d.resetPeek(),U}function L(d,E){const{currentType:w}=E;if(w!==9)return!1;x(d);const U=p(d.currentPeek());return d.resetPeek(),U}function D(d,E){const{currentType:w}=E;if(!(w===8||w===12))return!1;x(d);const U=d.currentPeek()===":";return d.resetPeek(),U}function M(d,E){const{currentType:w}=E;if(w!==10)return!1;const U=()=>{const Y=d.currentPeek();return Y==="{"?p(d.peek()):Y==="@"||Y==="%"||Y==="|"||Y===":"||Y==="."||Y===Vn||!Y?!1:Y===$t?(d.peek(),U()):B(d,!1)},G=U();return d.resetPeek(),G}function y(d){x(d);const E=d.currentPeek()==="|";return d.resetPeek(),E}function V(d){const E=x(d),w=d.currentPeek()==="%"&&d.peek()==="{";return d.resetPeek(),{isModulo:w,hasSpace:E.length>0}}function B(d,E=!0){const w=(G=!1,Y="",N=!1)=>{const F=d.currentPeek();return F==="{"?Y==="%"?!1:G:F==="@"||!F?Y==="%"?!0:G:F==="%"?(d.peek(),w(G,"%",!0)):F==="|"?Y==="%"||N?!0:!(Y===Vn||Y===$t):F===Vn?(d.peek(),w(!0,Vn,N)):F===$t?(d.peek(),w(!0,$t,N)):!0},U=w();return E&&d.resetPeek(),U}function O(d,E){const w=d.currentChar();return w===ci?ci:E(w)?(d.next(),w):null}function ee(d){const E=d.charCodeAt(0);return E>=97&&E<=122||E>=65&&E<=90||E>=48&&E<=57||E===95||E===36}function ne(d){return O(d,ee)}function se(d){const E=d.charCodeAt(0);return E>=97&&E<=122||E>=65&&E<=90||E>=48&&E<=57||E===95||E===36||E===45}function ie(d){return O(d,se)}function $(d){const E=d.charCodeAt(0);return E>=48&&E<=57}function ue(d){return O(d,$)}function fe(d){const E=d.charCodeAt(0);return E>=48&&E<=57||E>=65&&E<=70||E>=97&&E<=102}function ge(d){return O(d,fe)}function we(d){let E="",w="";for(;E=ue(d);)w+=E;return w}function qe(d){_(d);const E=d.currentChar();return E!=="%"&&f(Le.EXPECTED_TOKEN,s(),0,E),d.next(),"%"}function Q(d){let E="";for(;;){const w=d.currentChar();if(w==="{"||w==="}"||w==="@"||w==="|"||!w)break;if(w==="%")if(B(d))E+=w,d.next();else break;else if(w===Vn||w===$t)if(B(d))E+=w,d.next();else{if(y(d))break;E+=w,d.next()}else E+=w,d.next()}return E}function he(d){_(d);let E="",w="";for(;E=ie(d);)w+=E;return d.currentChar()===ci&&f(Le.UNTERMINATED_CLOSING_BRACE,s(),0),w}function me(d){_(d);let E="";return d.currentChar()==="-"?(d.next(),E+=`-${we(d)}`):E+=we(d),d.currentChar()===ci&&f(Le.UNTERMINATED_CLOSING_BRACE,s(),0),E}function de(d){return d!==ah&&d!==$t}function Ue(d){_(d),g(d,"'");let E="",w="";for(;E=O(d,de);)E==="\\"?w+=Fe(d):w+=E;const U=d.currentChar();return U===$t||U===ci?(f(Le.UNTERMINATED_SINGLE_QUOTE_IN_PLACEHOLDER,s(),0),U===$t&&(d.next(),g(d,"'")),w):(g(d,"'"),w)}function Fe(d){const E=d.currentChar();switch(E){case"\\":case"'":return d.next(),`\\${E}`;case"u":return W(d,E,4);case"U":return W(d,E,6);default:return f(Le.UNKNOWN_ESCAPE_SEQUENCE,s(),0,E),""}}function W(d,E,w){g(d,E);let U="";for(let G=0;G<w;G++){const Y=ge(d);if(!Y){f(Le.INVALID_UNICODE_ESCAPE_SEQUENCE,s(),0,`\\${E}${U}${d.currentChar()}`);break}U+=Y}return`\\${E}${U}`}function Ke(d){return d!=="{"&&d!=="}"&&d!==Vn&&d!==$t}function be(d){_(d);let E="",w="";for(;E=O(d,Ke);)w+=E;return w}function I(d){let E="",w="";for(;E=ne(d);)w+=E;return w}function b(d){const E=w=>{const U=d.currentChar();return U==="{"||U==="%"||U==="@"||U==="|"||U==="("||U===")"||!U||U===Vn?w:(w+=U,d.next(),E(w))};return E("")}function k(d){_(d);const E=g(d,"|");return _(d),E}function q(d,E){let w=null;switch(d.currentChar()){case"{":return E.braceNest>=1&&f(Le.NOT_ALLOW_NEST_PLACEHOLDER,s(),0),d.next(),w=h(E,2,"{"),_(d),E.braceNest++,w;case"}":return E.braceNest>0&&E.currentType===2&&f(Le.EMPTY_PLACEHOLDER,s(),0),d.next(),w=h(E,3,"}"),E.braceNest--,E.braceNest>0&&_(d),E.inLinked&&E.braceNest===0&&(E.inLinked=!1),w;case"@":return E.braceNest>0&&f(Le.UNTERMINATED_CLOSING_BRACE,s(),0),w=J(d,E)||m(E),E.braceNest=0,w;default:{let G=!0,Y=!0,N=!0;if(y(d))return E.braceNest>0&&f(Le.UNTERMINATED_CLOSING_BRACE,s(),0),w=h(E,1,k(d)),E.braceNest=0,E.inLinked=!1,w;if(E.braceNest>0&&(E.currentType===5||E.currentType===6||E.currentType===7))return f(Le.UNTERMINATED_CLOSING_BRACE,s(),0),E.braceNest=0,oe(d,E);if(G=v(d,E))return w=h(E,5,he(d)),_(d),w;if(Y=S(d,E))return w=h(E,6,me(d)),_(d),w;if(N=P(d,E))return w=h(E,7,Ue(d)),_(d),w;if(!G&&!Y&&!N)return w=h(E,13,be(d)),f(Le.INVALID_TOKEN_IN_PLACEHOLDER,s(),0,w.value),_(d),w;break}}return w}function J(d,E){const{currentType:w}=E;let U=null;const G=d.currentChar();switch((w===8||w===9||w===12||w===10)&&(G===$t||G===Vn)&&f(Le.INVALID_LINKED_FORMAT,s(),0),G){case"@":return d.next(),U=h(E,8,"@"),E.inLinked=!0,U;case".":return _(d),d.next(),h(E,9,".");case":":return _(d),d.next(),h(E,10,":");default:return y(d)?(U=h(E,1,k(d)),E.braceNest=0,E.inLinked=!1,U):T(d,E)||D(d,E)?(_(d),J(d,E)):L(d,E)?(_(d),h(E,12,I(d))):M(d,E)?(_(d),G==="{"?q(d,E)||U:h(E,11,b(d))):(w===8&&f(Le.INVALID_LINKED_FORMAT,s(),0),E.braceNest=0,E.inLinked=!1,oe(d,E))}}function oe(d,E){let w={type:14};if(E.braceNest>0)return q(d,E)||m(E);if(E.inLinked)return J(d,E)||m(E);switch(d.currentChar()){case"{":return q(d,E)||m(E);case"}":return f(Le.UNBALANCED_CLOSING_BRACE,s(),0),d.next(),h(E,3,"}");case"@":return J(d,E)||m(E);default:{if(y(d))return w=h(E,1,k(d)),E.braceNest=0,E.inLinked=!1,w;const{isModulo:G,hasSpace:Y}=V(d);if(G)return Y?h(E,0,Q(d)):h(E,4,qe(d));if(B(d))return h(E,0,Q(d));break}}return w}function A(){const{currentType:d,offset:E,startLoc:w,endLoc:U}=l;return l.lastType=d,l.lastOffset=E,l.lastStartLoc=w,l.lastEndLoc=U,l.offset=r(),l.startLoc=s(),i.currentChar()===ci?h(l,14):oe(i,l)}return{nextToken:A,currentOffset:r,currentPosition:s,context:c}}const Fb="parser",Bb=/(?:\\\\|\\'|\\u([0-9a-fA-F]{4})|\\U([0-9a-fA-F]{6}))/g;function kb(n,e,t){switch(n){case"\\\\":return"\\";case"\\'":return"'";default:{const i=parseInt(e||t,16);return i<=55295||i>=57344?String.fromCodePoint(i):"�"}}}function Hb(n={}){const e=n.location!==!1,{onError:t,onWarn:i}=n;function r(v,S,P,T,...L){const D=v.currentPosition();if(D.offset+=T,D.column+=T,t){const M=e?qo(P,D):null,y=Xr(S,M,{domain:Fb,args:L});t(y)}}function s(v,S,P,T,...L){const D=v.currentPosition();if(D.offset+=T,D.column+=T,i){const M=e?qo(P,D):null;i(wb(S,M,L))}}function o(v,S,P){const T={type:v};return e&&(T.start=S,T.end=S,T.loc={start:P,end:P}),T}function a(v,S,P,T){e&&(v.end=S,v.loc&&(v.loc.end=P))}function l(v,S){const P=v.context(),T=o(3,P.offset,P.startLoc);return T.value=S,a(T,v.currentOffset(),v.currentPosition()),T}function c(v,S){const P=v.context(),{lastOffset:T,lastStartLoc:L}=P,D=o(5,T,L);return D.index=parseInt(S,10),v.nextToken(),a(D,v.currentOffset(),v.currentPosition()),D}function u(v,S,P){const T=v.context(),{lastOffset:L,lastStartLoc:D}=T,M=o(4,L,D);return M.key=S,P===!0&&(M.modulo=!0),v.nextToken(),a(M,v.currentOffset(),v.currentPosition()),M}function f(v,S){const P=v.context(),{lastOffset:T,lastStartLoc:L}=P,D=o(9,T,L);return D.value=S.replace(Bb,kb),v.nextToken(),a(D,v.currentOffset(),v.currentPosition()),D}function h(v){const S=v.nextToken(),P=v.context(),{lastOffset:T,lastStartLoc:L}=P,D=o(8,T,L);return S.type!==12?(r(v,Le.UNEXPECTED_EMPTY_LINKED_MODIFIER,P.lastStartLoc,0),D.value="",a(D,T,L),{nextConsumeToken:S,node:D}):(S.value==null&&r(v,Le.UNEXPECTED_LEXICAL_ANALYSIS,P.lastStartLoc,0,xn(S)),D.value=S.value||"",a(D,v.currentOffset(),v.currentPosition()),{node:D})}function m(v,S){const P=v.context(),T=o(7,P.offset,P.startLoc);return T.value=S,a(T,v.currentOffset(),v.currentPosition()),T}function g(v){const S=v.context(),P=o(6,S.offset,S.startLoc);let T=v.nextToken();if(T.type===9){const L=h(v);P.modifier=L.node,T=L.nextConsumeToken||v.nextToken()}switch(T.type!==10&&r(v,Le.UNEXPECTED_LEXICAL_ANALYSIS,S.lastStartLoc,0,xn(T)),T=v.nextToken(),T.type===2&&(T=v.nextToken()),T.type){case 11:T.value==null&&r(v,Le.UNEXPECTED_LEXICAL_ANALYSIS,S.lastStartLoc,0,xn(T)),P.key=m(v,T.value||"");break;case 5:T.value==null&&r(v,Le.UNEXPECTED_LEXICAL_ANALYSIS,S.lastStartLoc,0,xn(T)),P.key=u(v,T.value||"");break;case 6:T.value==null&&r(v,Le.UNEXPECTED_LEXICAL_ANALYSIS,S.lastStartLoc,0,xn(T)),P.key=c(v,T.value||"");break;case 7:T.value==null&&r(v,Le.UNEXPECTED_LEXICAL_ANALYSIS,S.lastStartLoc,0,xn(T)),P.key=f(v,T.value||"");break;default:{r(v,Le.UNEXPECTED_EMPTY_LINKED_KEY,S.lastStartLoc,0);const L=v.context(),D=o(7,L.offset,L.startLoc);return D.value="",a(D,L.offset,L.startLoc),P.key=D,a(P,L.offset,L.startLoc),{nextConsumeToken:T,node:P}}}return a(P,v.currentOffset(),v.currentPosition()),{node:P}}function x(v){const S=v.context(),P=S.currentType===1?v.currentOffset():S.offset,T=S.currentType===1?S.endLoc:S.startLoc,L=o(2,P,T);L.items=[];let D=null,M=null;do{const B=D||v.nextToken();switch(D=null,B.type){case 0:B.value==null&&r(v,Le.UNEXPECTED_LEXICAL_ANALYSIS,S.lastStartLoc,0,xn(B)),L.items.push(l(v,B.value||""));break;case 6:B.value==null&&r(v,Le.UNEXPECTED_LEXICAL_ANALYSIS,S.lastStartLoc,0,xn(B)),L.items.push(c(v,B.value||""));break;case 4:M=!0;break;case 5:B.value==null&&r(v,Le.UNEXPECTED_LEXICAL_ANALYSIS,S.lastStartLoc,0,xn(B)),L.items.push(u(v,B.value||"",!!M)),M&&(s(v,Cc.USE_MODULO_SYNTAX,S.lastStartLoc,0,xn(B)),M=null);break;case 7:B.value==null&&r(v,Le.UNEXPECTED_LEXICAL_ANALYSIS,S.lastStartLoc,0,xn(B)),L.items.push(f(v,B.value||""));break;case 8:{const O=g(v);L.items.push(O.node),D=O.nextConsumeToken||null;break}}}while(S.currentType!==14&&S.currentType!==1);const y=S.currentType===1?S.lastOffset:v.currentOffset(),V=S.currentType===1?S.lastEndLoc:v.currentPosition();return a(L,y,V),L}function _(v,S,P,T){const L=v.context();let D=T.items.length===0;const M=o(1,S,P);M.cases=[],M.cases.push(T);do{const y=x(v);D||(D=y.items.length===0),M.cases.push(y)}while(L.currentType!==14);return D&&r(v,Le.MUST_HAVE_MESSAGES_IN_PLURAL,P,0),a(M,v.currentOffset(),v.currentPosition()),M}function p(v){const S=v.context(),{offset:P,startLoc:T}=S,L=x(v);return S.currentType===14?L:_(v,P,T,L)}function R(v){const S=Ob(v,Cp({},n)),P=S.context(),T=o(0,P.offset,P.startLoc);return e&&T.loc&&(T.loc.source=v),T.body=p(S),n.onCacheKey&&(T.cacheKey=n.onCacheKey(v)),P.currentType!==14&&r(S,Le.UNEXPECTED_LEXICAL_ANALYSIS,P.lastStartLoc,0,v[P.offset]||""),a(T,S.currentOffset(),S.currentPosition()),T}return{parse:R}}function xn(n){if(n.type===14)return"EOF";const e=(n.value||"").replace(/\r?\n/gu,"\\n");return e.length>10?e.slice(0,9)+"…":e}function zb(n,e={}){const t={ast:n,helpers:new Set};return{context:()=>t,helper:s=>(t.helpers.add(s),s)}}function lh(n,e){for(let t=0;t<n.length;t++)Lc(n[t],e)}function Lc(n,e){switch(n.type){case 1:lh(n.cases,e),e.helper("plural");break;case 2:lh(n.items,e);break;case 6:{Lc(n.key,e),e.helper("linked"),e.helper("type");break}case 5:e.helper("interpolate"),e.helper("list");break;case 4:e.helper("interpolate"),e.helper("named");break}}function Vb(n,e={}){const t=zb(n);t.helper("normalize"),n.body&&Lc(n.body,t);const i=t.context();n.helpers=Array.from(i.helpers)}function Gb(n){const e=n.body;return e.type===2?ch(e):e.cases.forEach(t=>ch(t)),n}function ch(n){if(n.items.length===1){const e=n.items[0];(e.type===3||e.type===9)&&(n.static=e.value,delete e.value)}else{const e=[];for(let t=0;t<n.items.length;t++){const i=n.items[t];if(!(i.type===3||i.type===9)||i.value==null)break;e.push(i.value)}if(e.length===n.items.length){n.static=Lp(e);for(let t=0;t<n.items.length;t++){const i=n.items[t];(i.type===3||i.type===9)&&delete i.value}}}}const Wb="minifier";function Mr(n){switch(n.t=n.type,n.type){case 0:{const e=n;Mr(e.body),e.b=e.body,delete e.body;break}case 1:{const e=n,t=e.cases;for(let i=0;i<t.length;i++)Mr(t[i]);e.c=t,delete e.cases;break}case 2:{const e=n,t=e.items;for(let i=0;i<t.length;i++)Mr(t[i]);e.i=t,delete e.items,e.static&&(e.s=e.static,delete e.static);break}case 3:case 9:case 8:case 7:{const e=n;e.value&&(e.v=e.value,delete e.value);break}case 6:{const e=n;Mr(e.key),e.k=e.key,delete e.key,e.modifier&&(Mr(e.modifier),e.m=e.modifier,delete e.modifier);break}case 5:{const e=n;e.i=e.index,delete e.index;break}case 4:{const e=n;e.k=e.key,delete e.key;break}default:throw Xr(Le.UNHANDLED_MINIFIER_NODE_TYPE,null,{domain:Wb,args:[n.type]})}delete n.type}const Xb="parser";function $b(n,e){const{sourceMap:t,filename:i,breakLineCode:r,needIndent:s}=e,o=e.location!==!1,a={filename:i,code:"",column:1,line:1,offset:0,map:void 0,breakLineCode:r,needIndent:s,indentLevel:0};o&&n.loc&&(a.source=n.loc.source);const l=()=>a;function c(_,p){a.code+=_}function u(_,p=!0){const R=p?r:"";c(s?R+"  ".repeat(_):R)}function f(_=!0){const p=++a.indentLevel;_&&u(p)}function h(_=!0){const p=--a.indentLevel;_&&u(p)}function m(){u(a.indentLevel)}return{context:l,push:c,indent:f,deindent:h,newline:m,helper:_=>`_${_}`,needIndent:()=>a.needIndent}}function Yb(n,e){const{helper:t}=n;n.push(`${t("linked")}(`),Br(n,e.key),e.modifier?(n.push(", "),Br(n,e.modifier),n.push(", _type")):n.push(", undefined, _type"),n.push(")")}function qb(n,e){const{helper:t,needIndent:i}=n;n.push(`${t("normalize")}([`),n.indent(i());const r=e.items.length;for(let s=0;s<r&&(Br(n,e.items[s]),s!==r-1);s++)n.push(", ");n.deindent(i()),n.push("])")}function jb(n,e){const{helper:t,needIndent:i}=n;if(e.cases.length>1){n.push(`${t("plural")}([`),n.indent(i());const r=e.cases.length;for(let s=0;s<r&&(Br(n,e.cases[s]),s!==r-1);s++)n.push(", ");n.deindent(i()),n.push("])")}}function Kb(n,e){e.body?Br(n,e.body):n.push("null")}function Br(n,e){const{helper:t}=n;switch(e.type){case 0:Kb(n,e);break;case 1:jb(n,e);break;case 2:qb(n,e);break;case 6:Yb(n,e);break;case 8:n.push(JSON.stringify(e.value),e);break;case 7:n.push(JSON.stringify(e.value),e);break;case 5:n.push(`${t("interpolate")}(${t("list")}(${e.index}))`,e);break;case 4:n.push(`${t("interpolate")}(${t("named")}(${JSON.stringify(e.key)}))`,e);break;case 9:n.push(JSON.stringify(e.value),e);break;case 3:n.push(JSON.stringify(e.value),e);break;default:throw Xr(Le.UNHANDLED_CODEGEN_NODE_TYPE,null,{domain:Xb,args:[e.type]})}}const Jb=(n,e={})=>{const t=oh(e.mode)?e.mode:"normal",i=oh(e.filename)?e.filename:"message.intl",r=!!e.sourceMap,s=e.breakLineCode!=null?e.breakLineCode:t==="arrow"?";":`
`,o=e.needIndent?e.needIndent:t!=="arrow",a=n.helpers||[],l=$b(n,{mode:t,filename:i,sourceMap:r,breakLineCode:s,needIndent:o});l.push(t==="normal"?"function __msg__ (ctx) {":"(ctx) => {"),l.indent(o),a.length>0&&(l.push(`const { ${Lp(a.map(f=>`${f}: _${f}`),", ")} } = ctx`),l.newline()),l.push("return "),Br(l,n),l.deindent(o),l.push("}"),delete n.helpers;const{code:c,map:u}=l.context();return{ast:n,code:c,map:u?u.toJSON():void 0}};function Zb(n,e={}){const t=Cp({},e),i=!!t.jit,r=!!t.minify,s=t.optimize==null?!0:t.optimize,a=Hb(t).parse(n);return i?(s&&Gb(a),r&&Mr(a),{ast:a,code:""}):(Vb(a,t),Jb(a,t))}/*!
  * core-base v9.13.1
  * (c) 2024 kazuya kawaguchi
  * Released under the MIT License.
  */function Qb(){typeof __INTLIFY_PROD_DEVTOOLS__!="boolean"&&($n().__INTLIFY_PROD_DEVTOOLS__=!1),typeof __INTLIFY_JIT_COMPILATION__!="boolean"&&($n().__INTLIFY_JIT_COMPILATION__=!1),typeof __INTLIFY_DROP_MESSAGE_COMPILER__!="boolean"&&($n().__INTLIFY_DROP_MESSAGE_COMPILER__=!1)}const Pi=[];Pi[0]={w:[0],i:[3,0],"[":[4],o:[7]};Pi[1]={w:[1],".":[2],"[":[4],o:[7]};Pi[2]={w:[2],i:[3,0],0:[3,0]};Pi[3]={i:[3,0],0:[3,0],w:[1,1],".":[2,1],"[":[4,1],o:[7,1]};Pi[4]={"'":[5,0],'"':[6,0],"[":[4,2],"]":[1,3],o:8,l:[4,0]};Pi[5]={"'":[4,0],o:8,l:[5,0]};Pi[6]={'"':[4,0],o:8,l:[6,0]};const eA=/^\s?(?:true|false|-?[\d.]+|'[^']*'|"[^"]*")\s?$/;function tA(n){return eA.test(n)}function nA(n){const e=n.charCodeAt(0),t=n.charCodeAt(n.length-1);return e===t&&(e===34||e===39)?n.slice(1,-1):n}function iA(n){if(n==null)return"o";switch(n.charCodeAt(0)){case 91:case 93:case 46:case 34:case 39:return n;case 95:case 36:case 45:return"i";case 9:case 10:case 13:case 160:case 65279:case 8232:case 8233:return"w"}return"i"}function rA(n){const e=n.trim();return n.charAt(0)==="0"&&isNaN(parseInt(n))?!1:tA(e)?nA(e):"*"+e}function sA(n){const e=[];let t=-1,i=0,r=0,s,o,a,l,c,u,f;const h=[];h[0]=()=>{o===void 0?o=a:o+=a},h[1]=()=>{o!==void 0&&(e.push(o),o=void 0)},h[2]=()=>{h[0](),r++},h[3]=()=>{if(r>0)r--,i=4,h[0]();else{if(r=0,o===void 0||(o=rA(o),o===!1))return!1;h[1]()}};function m(){const g=n[t+1];if(i===5&&g==="'"||i===6&&g==='"')return t++,a="\\"+g,h[0](),!0}for(;i!==null;)if(t++,s=n[t],!(s==="\\"&&m())){if(l=iA(s),f=Pi[i],c=f[l]||f.l||8,c===8||(i=c[0],c[1]!==void 0&&(u=h[c[1]],u&&(a=s,u()===!1))))return;if(i===7)return e}}const uh=new Map;function oA(n,e){return it(n)?n[e]:null}function aA(n,e){if(!it(n))return null;let t=uh.get(e);if(t||(t=sA(e),t&&uh.set(e,t)),!t)return null;const i=t.length;let r=n,s=0;for(;s<i;){const o=r[t[s]];if(o===void 0||ot(r))return null;r=o,s++}return r}const lA=n=>n,cA=n=>"",uA="text",fA=n=>n.length===0?"":Sb(n),hA=Eb;function fh(n,e){return n=Math.abs(n),e===2?n?n>1?1:0:1:n?Math.min(n,2):0}function dA(n){const e=St(n.pluralIndex)?n.pluralIndex:-1;return n.named&&(St(n.named.count)||St(n.named.n))?St(n.named.count)?n.named.count:St(n.named.n)?n.named.n:e:e}function pA(n,e){e.count||(e.count=n),e.n||(e.n=n)}function mA(n={}){const e=n.locale,t=dA(n),i=it(n.pluralRules)&&ve(e)&&ot(n.pluralRules[e])?n.pluralRules[e]:fh,r=it(n.pluralRules)&&ve(e)&&ot(n.pluralRules[e])?fh:void 0,s=p=>p[i(t,p.length,r)],o=n.list||[],a=p=>o[p],l=n.named||{};St(n.pluralIndex)&&pA(t,l);const c=p=>l[p];function u(p){const R=ot(n.messages)?n.messages(p):it(n.messages)?n.messages[p]:!1;return R||(n.parent?n.parent.message(p):cA)}const f=p=>n.modifiers?n.modifiers[p]:lA,h=Oe(n.processor)&&ot(n.processor.normalize)?n.processor.normalize:fA,m=Oe(n.processor)&&ot(n.processor.interpolate)?n.processor.interpolate:hA,g=Oe(n.processor)&&ve(n.processor.type)?n.processor.type:uA,_={list:a,named:c,plural:s,linked:(p,...R)=>{const[v,S]=R;let P="text",T="";R.length===1?it(v)?(T=v.modifier||T,P=v.type||P):ve(v)&&(T=v||T):R.length===2&&(ve(v)&&(T=v||T),ve(S)&&(P=S||P));const L=u(p)(_),D=P==="vnode"&&ut(L)&&T?L[0]:L;return T?f(T)(D,P):D},message:u,type:g,interpolate:m,normalize:h,values:Pt({},o,l)};return _}let Ss=null;function _A(n){Ss=n}function gA(n,e,t){Ss&&Ss.emit("i18n:init",{timestamp:Date.now(),i18n:n,version:e,meta:t})}const vA=xA("function:translate");function xA(n){return e=>Ss&&Ss.emit(n,e)}const Pp=Cc.__EXTEND_POINT__,Gi=va(Pp),EA={NOT_FOUND_KEY:Pp,FALLBACK_TO_TRANSLATE:Gi(),CANNOT_FORMAT_NUMBER:Gi(),FALLBACK_TO_NUMBER_FORMAT:Gi(),CANNOT_FORMAT_DATE:Gi(),FALLBACK_TO_DATE_FORMAT:Gi(),EXPERIMENTAL_CUSTOM_MESSAGE_COMPILER:Gi(),__EXTEND_POINT__:Gi()},Ip=Le.__EXTEND_POINT__,Wi=va(Ip),An={INVALID_ARGUMENT:Ip,INVALID_DATE_ARGUMENT:Wi(),INVALID_ISO_DATE_ARGUMENT:Wi(),NOT_SUPPORT_NON_STRING_MESSAGE:Wi(),NOT_SUPPORT_LOCALE_PROMISE_VALUE:Wi(),NOT_SUPPORT_LOCALE_ASYNC_FUNCTION:Wi(),NOT_SUPPORT_LOCALE_TYPE:Wi(),__EXTEND_POINT__:Wi()};function Dn(n){return Xr(n,null,void 0)}function Pc(n,e){return e.locale!=null?hh(e.locale):hh(n.locale)}let vl;function hh(n){if(ve(n))return n;if(ot(n)){if(n.resolvedOnce&&vl!=null)return vl;if(n.constructor.name==="Function"){const e=n();if(xb(e))throw Dn(An.NOT_SUPPORT_LOCALE_PROMISE_VALUE);return vl=e}else throw Dn(An.NOT_SUPPORT_LOCALE_ASYNC_FUNCTION)}else throw Dn(An.NOT_SUPPORT_LOCALE_TYPE)}function SA(n,e,t){return[...new Set([t,...ut(e)?e:it(e)?Object.keys(e):ve(e)?[e]:[t]])]}function Np(n,e,t){const i=ve(t)?t:kr,r=n;r.__localeChainCache||(r.__localeChainCache=new Map);let s=r.__localeChainCache.get(i);if(!s){s=[];let o=[t];for(;ut(o);)o=dh(s,o,e);const a=ut(e)||!Oe(e)?e:e.default?e.default:null;o=ve(a)?[a]:a,ut(o)&&dh(s,o,!1),r.__localeChainCache.set(i,s)}return s}function dh(n,e,t){let i=!0;for(let r=0;r<e.length&&$e(i);r++){const s=e[r];ve(s)&&(i=MA(n,e[r],t))}return i}function MA(n,e,t){let i;const r=e.split("-");do{const s=r.join("-");i=yA(n,s,t),r.splice(-1,1)}while(r.length&&i===!0);return i}function yA(n,e,t){let i=!1;if(!n.includes(e)&&(i=!0,e)){i=e[e.length-1]!=="!";const r=e.replace(/!/g,"");n.push(r),(ut(t)||Oe(t))&&t[r]&&(i=t[r])}return i}const TA="9.13.1",xa=-1,kr="en-US",ph="",mh=n=>`${n.charAt(0).toLocaleUpperCase()}${n.substr(1)}`;function bA(){return{upper:(n,e)=>e==="text"&&ve(n)?n.toUpperCase():e==="vnode"&&it(n)&&"__v_isVNode"in n?n.children.toUpperCase():n,lower:(n,e)=>e==="text"&&ve(n)?n.toLowerCase():e==="vnode"&&it(n)&&"__v_isVNode"in n?n.children.toLowerCase():n,capitalize:(n,e)=>e==="text"&&ve(n)?mh(n):e==="vnode"&&it(n)&&"__v_isVNode"in n?mh(n.children):n}}let Dp;function _h(n){Dp=n}let Up;function AA(n){Up=n}let Op;function wA(n){Op=n}let Fp=null;const RA=n=>{Fp=n},CA=()=>Fp;let Bp=null;const gh=n=>{Bp=n},LA=()=>Bp;let vh=0;function PA(n={}){const e=ot(n.onWarn)?n.onWarn:Mb,t=ve(n.version)?n.version:TA,i=ve(n.locale)||ot(n.locale)?n.locale:kr,r=ot(i)?kr:i,s=ut(n.fallbackLocale)||Oe(n.fallbackLocale)||ve(n.fallbackLocale)||n.fallbackLocale===!1?n.fallbackLocale:r,o=Oe(n.messages)?n.messages:{[r]:{}},a=Oe(n.datetimeFormats)?n.datetimeFormats:{[r]:{}},l=Oe(n.numberFormats)?n.numberFormats:{[r]:{}},c=Pt({},n.modifiers||{},bA()),u=n.pluralRules||{},f=ot(n.missing)?n.missing:null,h=$e(n.missingWarn)||Ai(n.missingWarn)?n.missingWarn:!0,m=$e(n.fallbackWarn)||Ai(n.fallbackWarn)?n.fallbackWarn:!0,g=!!n.fallbackFormat,x=!!n.unresolving,_=ot(n.postTranslation)?n.postTranslation:null,p=Oe(n.processor)?n.processor:null,R=$e(n.warnHtmlMessage)?n.warnHtmlMessage:!0,v=!!n.escapeParameter,S=ot(n.messageCompiler)?n.messageCompiler:Dp,P=ot(n.messageResolver)?n.messageResolver:Up||oA,T=ot(n.localeFallbacker)?n.localeFallbacker:Op||SA,L=it(n.fallbackContext)?n.fallbackContext:void 0,D=n,M=it(D.__datetimeFormatters)?D.__datetimeFormatters:new Map,y=it(D.__numberFormatters)?D.__numberFormatters:new Map,V=it(D.__meta)?D.__meta:{};vh++;const B={version:t,cid:vh,locale:i,fallbackLocale:s,messages:o,modifiers:c,pluralRules:u,missing:f,missingWarn:h,fallbackWarn:m,fallbackFormat:g,unresolving:x,postTranslation:_,processor:p,warnHtmlMessage:R,escapeParameter:v,messageCompiler:S,messageResolver:P,localeFallbacker:T,fallbackContext:L,onWarn:e,__meta:V};return B.datetimeFormats=a,B.numberFormats=l,B.__datetimeFormatters=M,B.__numberFormatters=y,__INTLIFY_PROD_DEVTOOLS__&&gA(B,t,V),B}function Ic(n,e,t,i,r){const{missing:s,onWarn:o}=n;if(s!==null){const a=s(n,t,e,r);return ve(a)?a:e}else return e}function ts(n,e,t){const i=n;i.__localeChainCache=new Map,n.localeFallbacker(n,t,e)}function IA(n,e){return n===e?!1:n.split("-")[0]===e.split("-")[0]}function NA(n,e){const t=e.indexOf(n);if(t===-1)return!1;for(let i=t+1;i<e.length;i++)if(IA(n,e[i]))return!0;return!1}function xl(n){return t=>DA(t,n)}function DA(n,e){const t=e.b||e.body;if((t.t||t.type)===1){const i=t,r=i.c||i.cases;return n.plural(r.reduce((s,o)=>[...s,xh(n,o)],[]))}else return xh(n,t)}function xh(n,e){const t=e.s||e.static;if(t)return n.type==="text"?t:n.normalize([t]);{const i=(e.i||e.items).reduce((r,s)=>[...r,Gl(n,s)],[]);return n.normalize(i)}}function Gl(n,e){const t=e.t||e.type;switch(t){case 3:{const i=e;return i.v||i.value}case 9:{const i=e;return i.v||i.value}case 4:{const i=e;return n.interpolate(n.named(i.k||i.key))}case 5:{const i=e;return n.interpolate(n.list(i.i!=null?i.i:i.index))}case 6:{const i=e,r=i.m||i.modifier;return n.linked(Gl(n,i.k||i.key),r?Gl(n,r):void 0,n.type)}case 7:{const i=e;return i.v||i.value}case 8:{const i=e;return i.v||i.value}default:throw new Error(`unhandled node type on format message part: ${t}`)}}const kp=n=>n;let br=Object.create(null);const Hr=n=>it(n)&&(n.t===0||n.type===0)&&("b"in n||"body"in n);function Hp(n,e={}){let t=!1;const i=e.onError||Cb;return e.onError=r=>{t=!0,i(r)},{...Zb(n,e),detectError:t}}const UA=(n,e)=>{if(!ve(n))throw Dn(An.NOT_SUPPORT_NON_STRING_MESSAGE);{$e(e.warnHtmlMessage)&&e.warnHtmlMessage;const i=(e.onCacheKey||kp)(n),r=br[i];if(r)return r;const{code:s,detectError:o}=Hp(n,e),a=new Function(`return ${s}`)();return o?a:br[i]=a}};function OA(n,e){if(__INTLIFY_JIT_COMPILATION__&&!__INTLIFY_DROP_MESSAGE_COMPILER__&&ve(n)){$e(e.warnHtmlMessage)&&e.warnHtmlMessage;const i=(e.onCacheKey||kp)(n),r=br[i];if(r)return r;const{ast:s,detectError:o}=Hp(n,{...e,location:!1,jit:!0}),a=xl(s);return o?a:br[i]=a}else{const t=n.cacheKey;if(t){const i=br[t];return i||(br[t]=xl(n))}else return xl(n)}}const Eh=()=>"",fn=n=>ot(n);function Sh(n,...e){const{fallbackFormat:t,postTranslation:i,unresolving:r,messageCompiler:s,fallbackLocale:o,messages:a}=n,[l,c]=Wl(...e),u=$e(c.missingWarn)?c.missingWarn:n.missingWarn,f=$e(c.fallbackWarn)?c.fallbackWarn:n.fallbackWarn,h=$e(c.escapeParameter)?c.escapeParameter:n.escapeParameter,m=!!c.resolvedMessage,g=ve(c.default)||$e(c.default)?$e(c.default)?s?l:()=>l:c.default:t?s?l:()=>l:"",x=t||g!=="",_=Pc(n,c);h&&FA(c);let[p,R,v]=m?[l,_,a[_]||{}]:zp(n,l,_,o,f,u),S=p,P=l;if(!m&&!(ve(S)||Hr(S)||fn(S))&&x&&(S=g,P=S),!m&&(!(ve(S)||Hr(S)||fn(S))||!ve(R)))return r?xa:l;let T=!1;const L=()=>{T=!0},D=fn(S)?S:Vp(n,l,R,S,P,L);if(T)return S;const M=HA(n,R,v,c),y=mA(M),V=BA(n,D,y),B=i?i(V,l):V;if(__INTLIFY_PROD_DEVTOOLS__){const O={timestamp:Date.now(),key:ve(l)?l:fn(S)?S.key:"",locale:R||(fn(S)?S.locale:""),format:ve(S)?S:fn(S)?S.source:"",message:B};O.meta=Pt({},n.__meta,CA()||{}),vA(O)}return B}function FA(n){ut(n.list)?n.list=n.list.map(e=>ve(e)?sh(e):e):it(n.named)&&Object.keys(n.named).forEach(e=>{ve(n.named[e])&&(n.named[e]=sh(n.named[e]))})}function zp(n,e,t,i,r,s){const{messages:o,onWarn:a,messageResolver:l,localeFallbacker:c}=n,u=c(n,i,t);let f={},h,m=null;const g="translate";for(let x=0;x<u.length&&(h=u[x],f=o[h]||{},(m=l(f,e))===null&&(m=f[e]),!(ve(m)||Hr(m)||fn(m)));x++)if(!NA(h,u)){const _=Ic(n,e,h,s,g);_!==e&&(m=_)}return[m,h,f]}function Vp(n,e,t,i,r,s){const{messageCompiler:o,warnHtmlMessage:a}=n;if(fn(i)){const c=i;return c.locale=c.locale||t,c.key=c.key||e,c}if(o==null){const c=()=>i;return c.locale=t,c.key=e,c}const l=o(i,kA(n,t,r,i,a,s));return l.locale=t,l.key=e,l.source=i,l}function BA(n,e,t){return e(t)}function Wl(...n){const[e,t,i]=n,r={};if(!ve(e)&&!St(e)&&!fn(e)&&!Hr(e))throw Dn(An.INVALID_ARGUMENT);const s=St(e)?String(e):(fn(e),e);return St(t)?r.plural=t:ve(t)?r.default=t:Oe(t)&&!ga(t)?r.named=t:ut(t)&&(r.list=t),St(i)?r.plural=i:ve(i)?r.default=i:Oe(i)&&Pt(r,i),[s,r]}function kA(n,e,t,i,r,s){return{locale:e,key:t,warnHtmlMessage:r,onError:o=>{throw s&&s(o),o},onCacheKey:o=>mb(e,t,o)}}function HA(n,e,t,i){const{modifiers:r,pluralRules:s,messageResolver:o,fallbackLocale:a,fallbackWarn:l,missingWarn:c,fallbackContext:u}=n,h={locale:e,modifiers:r,pluralRules:s,messages:m=>{let g=o(t,m);if(g==null&&u){const[,,x]=zp(u,m,e,a,l,c);g=o(x,m)}if(ve(g)||Hr(g)){let x=!1;const p=Vp(n,m,e,g,m,()=>{x=!0});return x?Eh:p}else return fn(g)?g:Eh}};return n.processor&&(h.processor=n.processor),i.list&&(h.list=i.list),i.named&&(h.named=i.named),St(i.plural)&&(h.pluralIndex=i.plural),h}function Mh(n,...e){const{datetimeFormats:t,unresolving:i,fallbackLocale:r,onWarn:s,localeFallbacker:o}=n,{__datetimeFormatters:a}=n,[l,c,u,f]=Xl(...e),h=$e(u.missingWarn)?u.missingWarn:n.missingWarn;$e(u.fallbackWarn)?u.fallbackWarn:n.fallbackWarn;const m=!!u.part,g=Pc(n,u),x=o(n,r,g);if(!ve(l)||l==="")return new Intl.DateTimeFormat(g,f).format(c);let _={},p,R=null;const v="datetime format";for(let T=0;T<x.length&&(p=x[T],_=t[p]||{},R=_[l],!Oe(R));T++)Ic(n,l,p,h,v);if(!Oe(R)||!ve(p))return i?xa:l;let S=`${p}__${l}`;ga(f)||(S=`${S}__${JSON.stringify(f)}`);let P=a.get(S);return P||(P=new Intl.DateTimeFormat(p,Pt({},R,f)),a.set(S,P)),m?P.formatToParts(c):P.format(c)}const Gp=["localeMatcher","weekday","era","year","month","day","hour","minute","second","timeZoneName","formatMatcher","hour12","timeZone","dateStyle","timeStyle","calendar","dayPeriod","numberingSystem","hourCycle","fractionalSecondDigits"];function Xl(...n){const[e,t,i,r]=n,s={};let o={},a;if(ve(e)){const l=e.match(/(\d{4}-\d{2}-\d{2})(T|\s)?(.*)/);if(!l)throw Dn(An.INVALID_ISO_DATE_ARGUMENT);const c=l[3]?l[3].trim().startsWith("T")?`${l[1].trim()}${l[3].trim()}`:`${l[1].trim()}T${l[3].trim()}`:l[1].trim();a=new Date(c);try{a.toISOString()}catch{throw Dn(An.INVALID_ISO_DATE_ARGUMENT)}}else if(gb(e)){if(isNaN(e.getTime()))throw Dn(An.INVALID_DATE_ARGUMENT);a=e}else if(St(e))a=e;else throw Dn(An.INVALID_ARGUMENT);return ve(t)?s.key=t:Oe(t)&&Object.keys(t).forEach(l=>{Gp.includes(l)?o[l]=t[l]:s[l]=t[l]}),ve(i)?s.locale=i:Oe(i)&&(o=i),Oe(r)&&(o=r),[s.key||"",a,s,o]}function yh(n,e,t){const i=n;for(const r in t){const s=`${e}__${r}`;i.__datetimeFormatters.has(s)&&i.__datetimeFormatters.delete(s)}}function Th(n,...e){const{numberFormats:t,unresolving:i,fallbackLocale:r,onWarn:s,localeFallbacker:o}=n,{__numberFormatters:a}=n,[l,c,u,f]=$l(...e),h=$e(u.missingWarn)?u.missingWarn:n.missingWarn;$e(u.fallbackWarn)?u.fallbackWarn:n.fallbackWarn;const m=!!u.part,g=Pc(n,u),x=o(n,r,g);if(!ve(l)||l==="")return new Intl.NumberFormat(g,f).format(c);let _={},p,R=null;const v="number format";for(let T=0;T<x.length&&(p=x[T],_=t[p]||{},R=_[l],!Oe(R));T++)Ic(n,l,p,h,v);if(!Oe(R)||!ve(p))return i?xa:l;let S=`${p}__${l}`;ga(f)||(S=`${S}__${JSON.stringify(f)}`);let P=a.get(S);return P||(P=new Intl.NumberFormat(p,Pt({},R,f)),a.set(S,P)),m?P.formatToParts(c):P.format(c)}const Wp=["localeMatcher","style","currency","currencyDisplay","currencySign","useGrouping","minimumIntegerDigits","minimumFractionDigits","maximumFractionDigits","minimumSignificantDigits","maximumSignificantDigits","compactDisplay","notation","signDisplay","unit","unitDisplay","roundingMode","roundingPriority","roundingIncrement","trailingZeroDisplay"];function $l(...n){const[e,t,i,r]=n,s={};let o={};if(!St(e))throw Dn(An.INVALID_ARGUMENT);const a=e;return ve(t)?s.key=t:Oe(t)&&Object.keys(t).forEach(l=>{Wp.includes(l)?o[l]=t[l]:s[l]=t[l]}),ve(i)?s.locale=i:Oe(i)&&(o=i),Oe(r)&&(o=r),[s.key||"",a,s,o]}function bh(n,e,t){const i=n;for(const r in t){const s=`${e}__${r}`;i.__numberFormatters.has(s)&&i.__numberFormatters.delete(s)}}Qb();/*!
  * vue-i18n v9.13.1
  * (c) 2024 kazuya kawaguchi
  * Released under the MIT License.
  */const zA="9.13.1";function VA(){typeof __VUE_I18N_FULL_INSTALL__!="boolean"&&($n().__VUE_I18N_FULL_INSTALL__=!0),typeof __VUE_I18N_LEGACY_API__!="boolean"&&($n().__VUE_I18N_LEGACY_API__=!0),typeof __INTLIFY_JIT_COMPILATION__!="boolean"&&($n().__INTLIFY_JIT_COMPILATION__=!1),typeof __INTLIFY_DROP_MESSAGE_COMPILER__!="boolean"&&($n().__INTLIFY_DROP_MESSAGE_COMPILER__=!1),typeof __INTLIFY_PROD_DEVTOOLS__!="boolean"&&($n().__INTLIFY_PROD_DEVTOOLS__=!1)}const Xp=EA.__EXTEND_POINT__,Gn=va(Xp);Gn(),Gn(),Gn(),Gn(),Gn(),Gn(),Gn(),Gn(),Gn();const $p=An.__EXTEND_POINT__,Zt=va($p),Mt={UNEXPECTED_RETURN_TYPE:$p,INVALID_ARGUMENT:Zt(),MUST_BE_CALL_SETUP_TOP:Zt(),NOT_INSTALLED:Zt(),NOT_AVAILABLE_IN_LEGACY_MODE:Zt(),REQUIRED_VALUE:Zt(),INVALID_VALUE:Zt(),CANNOT_SETUP_VUE_DEVTOOLS_PLUGIN:Zt(),NOT_INSTALLED_WITH_PROVIDE:Zt(),UNEXPECTED_ERROR:Zt(),NOT_COMPATIBLE_LEGACY_VUE_I18N:Zt(),BRIDGE_SUPPORT_VUE_2_ONLY:Zt(),MUST_DEFINE_I18N_OPTION_IN_ALLOW_COMPOSITION:Zt(),NOT_AVAILABLE_COMPOSITION_IN_LEGACY:Zt(),__EXTEND_POINT__:Zt()};function Rt(n,...e){return Xr(n,null,void 0)}const Yl=Li("__translateVNode"),ql=Li("__datetimeParts"),jl=Li("__numberParts"),Yp=Li("__setPluralRules"),qp=Li("__injectWithOption"),Kl=Li("__dispose");function Ms(n){if(!it(n))return n;for(const e in n)if(Yo(n,e))if(!e.includes("."))it(n[e])&&Ms(n[e]);else{const t=e.split("."),i=t.length-1;let r=n,s=!1;for(let o=0;o<i;o++){if(t[o]in r||(r[t[o]]={}),!it(r[t[o]])){s=!0;break}r=r[t[o]]}s||(r[t[i]]=n[e],delete n[e]),it(r[t[i]])&&Ms(r[t[i]])}return n}function Ea(n,e){const{messages:t,__i18n:i,messageResolver:r,flatJson:s}=e,o=Oe(t)?t:ut(i)?{}:{[n]:{}};if(ut(i)&&i.forEach(a=>{if("locale"in a&&"resource"in a){const{locale:l,resource:c}=a;l?(o[l]=o[l]||{},Co(c,o[l])):Co(c,o)}else ve(a)&&Co(JSON.parse(a),o)}),r==null&&s)for(const a in o)Yo(o,a)&&Ms(o[a]);return o}function jp(n){return n.type}function Kp(n,e,t){let i=it(e.messages)?e.messages:{};"__i18nGlobal"in t&&(i=Ea(n.locale.value,{messages:i,__i18n:t.__i18nGlobal}));const r=Object.keys(i);r.length&&r.forEach(s=>{n.mergeLocaleMessage(s,i[s])});{if(it(e.datetimeFormats)){const s=Object.keys(e.datetimeFormats);s.length&&s.forEach(o=>{n.mergeDateTimeFormat(o,e.datetimeFormats[o])})}if(it(e.numberFormats)){const s=Object.keys(e.numberFormats);s.length&&s.forEach(o=>{n.mergeNumberFormat(o,e.numberFormats[o])})}}}function Ah(n){return Qe(Ts,null,n,0)}const wh="__INTLIFY_META__",Rh=()=>[],GA=()=>!1;let Ch=0;function Lh(n){return(e,t,i,r)=>n(t,i,Nr()||void 0,r)}const WA=()=>{const n=Nr();let e=null;return n&&(e=jp(n)[wh])?{[wh]:e}:null};function Nc(n={},e){const{__root:t,__injectWithOption:i}=n,r=t===void 0,s=n.flatJson,o=$o?on:ld,a=!!n.translateExistCompatible;let l=$e(n.inheritLocale)?n.inheritLocale:!0;const c=o(t&&l?t.locale.value:ve(n.locale)?n.locale:kr),u=o(t&&l?t.fallbackLocale.value:ve(n.fallbackLocale)||ut(n.fallbackLocale)||Oe(n.fallbackLocale)||n.fallbackLocale===!1?n.fallbackLocale:c.value),f=o(Ea(c.value,n)),h=o(Oe(n.datetimeFormats)?n.datetimeFormats:{[c.value]:{}}),m=o(Oe(n.numberFormats)?n.numberFormats:{[c.value]:{}});let g=t?t.missingWarn:$e(n.missingWarn)||Ai(n.missingWarn)?n.missingWarn:!0,x=t?t.fallbackWarn:$e(n.fallbackWarn)||Ai(n.fallbackWarn)?n.fallbackWarn:!0,_=t?t.fallbackRoot:$e(n.fallbackRoot)?n.fallbackRoot:!0,p=!!n.fallbackFormat,R=ot(n.missing)?n.missing:null,v=ot(n.missing)?Lh(n.missing):null,S=ot(n.postTranslation)?n.postTranslation:null,P=t?t.warnHtmlMessage:$e(n.warnHtmlMessage)?n.warnHtmlMessage:!0,T=!!n.escapeParameter;const L=t?t.modifiers:Oe(n.modifiers)?n.modifiers:{};let D=n.pluralRules||t&&t.pluralRules,M;M=(()=>{r&&gh(null);const N={version:zA,locale:c.value,fallbackLocale:u.value,messages:f.value,modifiers:L,pluralRules:D,missing:v===null?void 0:v,missingWarn:g,fallbackWarn:x,fallbackFormat:p,unresolving:!0,postTranslation:S===null?void 0:S,warnHtmlMessage:P,escapeParameter:T,messageResolver:n.messageResolver,messageCompiler:n.messageCompiler,__meta:{framework:"vue"}};N.datetimeFormats=h.value,N.numberFormats=m.value,N.__datetimeFormatters=Oe(M)?M.__datetimeFormatters:void 0,N.__numberFormatters=Oe(M)?M.__numberFormatters:void 0;const F=PA(N);return r&&gh(F),F})(),ts(M,c.value,u.value);function V(){return[c.value,u.value,f.value,h.value,m.value]}const B=Sn({get:()=>c.value,set:N=>{c.value=N,M.locale=c.value}}),O=Sn({get:()=>u.value,set:N=>{u.value=N,M.fallbackLocale=u.value,ts(M,c.value,N)}}),ee=Sn(()=>f.value),ne=Sn(()=>h.value),se=Sn(()=>m.value);function ie(){return ot(S)?S:null}function $(N){S=N,M.postTranslation=N}function ue(){return R}function fe(N){N!==null&&(v=Lh(N)),R=N,M.missing=v}const ge=(N,F,ce,te,pe,Re)=>{V();let ye;try{__INTLIFY_PROD_DEVTOOLS__,r||(M.fallbackContext=t?LA():void 0),ye=N(M)}finally{__INTLIFY_PROD_DEVTOOLS__,r||(M.fallbackContext=void 0)}if(ce!=="translate exists"&&St(ye)&&ye===xa||ce==="translate exists"&&!ye){const[Se,De]=F();return t&&_?te(t):pe(Se)}else{if(Re(ye))return ye;throw Rt(Mt.UNEXPECTED_RETURN_TYPE)}};function we(...N){return ge(F=>Reflect.apply(Sh,null,[F,...N]),()=>Wl(...N),"translate",F=>Reflect.apply(F.t,F,[...N]),F=>F,F=>ve(F))}function qe(...N){const[F,ce,te]=N;if(te&&!it(te))throw Rt(Mt.INVALID_ARGUMENT);return we(F,ce,Pt({resolvedMessage:!0},te||{}))}function Q(...N){return ge(F=>Reflect.apply(Mh,null,[F,...N]),()=>Xl(...N),"datetime format",F=>Reflect.apply(F.d,F,[...N]),()=>ph,F=>ve(F))}function he(...N){return ge(F=>Reflect.apply(Th,null,[F,...N]),()=>$l(...N),"number format",F=>Reflect.apply(F.n,F,[...N]),()=>ph,F=>ve(F))}function me(N){return N.map(F=>ve(F)||St(F)||$e(F)?Ah(String(F)):F)}const Ue={normalize:me,interpolate:N=>N,type:"vnode"};function Fe(...N){return ge(F=>{let ce;const te=F;try{te.processor=Ue,ce=Reflect.apply(Sh,null,[te,...N])}finally{te.processor=null}return ce},()=>Wl(...N),"translate",F=>F[Yl](...N),F=>[Ah(F)],F=>ut(F))}function W(...N){return ge(F=>Reflect.apply(Th,null,[F,...N]),()=>$l(...N),"number format",F=>F[jl](...N),Rh,F=>ve(F)||ut(F))}function Ke(...N){return ge(F=>Reflect.apply(Mh,null,[F,...N]),()=>Xl(...N),"datetime format",F=>F[ql](...N),Rh,F=>ve(F)||ut(F))}function be(N){D=N,M.pluralRules=D}function I(N,F){return ge(()=>{if(!N)return!1;const ce=ve(F)?F:c.value,te=q(ce),pe=M.messageResolver(te,N);return a?pe!=null:Hr(pe)||fn(pe)||ve(pe)},()=>[N],"translate exists",ce=>Reflect.apply(ce.te,ce,[N,F]),GA,ce=>$e(ce))}function b(N){let F=null;const ce=Np(M,u.value,c.value);for(let te=0;te<ce.length;te++){const pe=f.value[ce[te]]||{},Re=M.messageResolver(pe,N);if(Re!=null){F=Re;break}}return F}function k(N){const F=b(N);return F??(t?t.tm(N)||{}:{})}function q(N){return f.value[N]||{}}function J(N,F){if(s){const ce={[N]:F};for(const te in ce)Yo(ce,te)&&Ms(ce[te]);F=ce[N]}f.value[N]=F,M.messages=f.value}function oe(N,F){f.value[N]=f.value[N]||{};const ce={[N]:F};if(s)for(const te in ce)Yo(ce,te)&&Ms(ce[te]);F=ce[N],Co(F,f.value[N]),M.messages=f.value}function A(N){return h.value[N]||{}}function d(N,F){h.value[N]=F,M.datetimeFormats=h.value,yh(M,N,F)}function E(N,F){h.value[N]=Pt(h.value[N]||{},F),M.datetimeFormats=h.value,yh(M,N,F)}function w(N){return m.value[N]||{}}function U(N,F){m.value[N]=F,M.numberFormats=m.value,bh(M,N,F)}function G(N,F){m.value[N]=Pt(m.value[N]||{},F),M.numberFormats=m.value,bh(M,N,F)}Ch++,t&&$o&&(Cr(t.locale,N=>{l&&(c.value=N,M.locale=N,ts(M,c.value,u.value))}),Cr(t.fallbackLocale,N=>{l&&(u.value=N,M.fallbackLocale=N,ts(M,c.value,u.value))}));const Y={id:Ch,locale:B,fallbackLocale:O,get inheritLocale(){return l},set inheritLocale(N){l=N,N&&t&&(c.value=t.locale.value,u.value=t.fallbackLocale.value,ts(M,c.value,u.value))},get availableLocales(){return Object.keys(f.value).sort()},messages:ee,get modifiers(){return L},get pluralRules(){return D||{}},get isGlobal(){return r},get missingWarn(){return g},set missingWarn(N){g=N,M.missingWarn=g},get fallbackWarn(){return x},set fallbackWarn(N){x=N,M.fallbackWarn=x},get fallbackRoot(){return _},set fallbackRoot(N){_=N},get fallbackFormat(){return p},set fallbackFormat(N){p=N,M.fallbackFormat=p},get warnHtmlMessage(){return P},set warnHtmlMessage(N){P=N,M.warnHtmlMessage=N},get escapeParameter(){return T},set escapeParameter(N){T=N,M.escapeParameter=N},t:we,getLocaleMessage:q,setLocaleMessage:J,mergeLocaleMessage:oe,getPostTranslationHandler:ie,setPostTranslationHandler:$,getMissingHandler:ue,setMissingHandler:fe,[Yp]:be};return Y.datetimeFormats=ne,Y.numberFormats=se,Y.rt=qe,Y.te=I,Y.tm=k,Y.d=Q,Y.n=he,Y.getDateTimeFormat=A,Y.setDateTimeFormat=d,Y.mergeDateTimeFormat=E,Y.getNumberFormat=w,Y.setNumberFormat=U,Y.mergeNumberFormat=G,Y[qp]=i,Y[Yl]=Fe,Y[ql]=Ke,Y[jl]=W,Y}function XA(n){const e=ve(n.locale)?n.locale:kr,t=ve(n.fallbackLocale)||ut(n.fallbackLocale)||Oe(n.fallbackLocale)||n.fallbackLocale===!1?n.fallbackLocale:e,i=ot(n.missing)?n.missing:void 0,r=$e(n.silentTranslationWarn)||Ai(n.silentTranslationWarn)?!n.silentTranslationWarn:!0,s=$e(n.silentFallbackWarn)||Ai(n.silentFallbackWarn)?!n.silentFallbackWarn:!0,o=$e(n.fallbackRoot)?n.fallbackRoot:!0,a=!!n.formatFallbackMessages,l=Oe(n.modifiers)?n.modifiers:{},c=n.pluralizationRules,u=ot(n.postTranslation)?n.postTranslation:void 0,f=ve(n.warnHtmlInMessage)?n.warnHtmlInMessage!=="off":!0,h=!!n.escapeParameterHtml,m=$e(n.sync)?n.sync:!0;let g=n.messages;if(Oe(n.sharedMessages)){const T=n.sharedMessages;g=Object.keys(T).reduce((D,M)=>{const y=D[M]||(D[M]={});return Pt(y,T[M]),D},g||{})}const{__i18n:x,__root:_,__injectWithOption:p}=n,R=n.datetimeFormats,v=n.numberFormats,S=n.flatJson,P=n.translateExistCompatible;return{locale:e,fallbackLocale:t,messages:g,flatJson:S,datetimeFormats:R,numberFormats:v,missing:i,missingWarn:r,fallbackWarn:s,fallbackRoot:o,fallbackFormat:a,modifiers:l,pluralRules:c,postTranslation:u,warnHtmlMessage:f,escapeParameter:h,messageResolver:n.messageResolver,inheritLocale:m,translateExistCompatible:P,__i18n:x,__root:_,__injectWithOption:p}}function Jl(n={},e){{const t=Nc(XA(n)),{__extender:i}=n,r={id:t.id,get locale(){return t.locale.value},set locale(s){t.locale.value=s},get fallbackLocale(){return t.fallbackLocale.value},set fallbackLocale(s){t.fallbackLocale.value=s},get messages(){return t.messages.value},get datetimeFormats(){return t.datetimeFormats.value},get numberFormats(){return t.numberFormats.value},get availableLocales(){return t.availableLocales},get formatter(){return{interpolate(){return[]}}},set formatter(s){},get missing(){return t.getMissingHandler()},set missing(s){t.setMissingHandler(s)},get silentTranslationWarn(){return $e(t.missingWarn)?!t.missingWarn:t.missingWarn},set silentTranslationWarn(s){t.missingWarn=$e(s)?!s:s},get silentFallbackWarn(){return $e(t.fallbackWarn)?!t.fallbackWarn:t.fallbackWarn},set silentFallbackWarn(s){t.fallbackWarn=$e(s)?!s:s},get modifiers(){return t.modifiers},get formatFallbackMessages(){return t.fallbackFormat},set formatFallbackMessages(s){t.fallbackFormat=s},get postTranslation(){return t.getPostTranslationHandler()},set postTranslation(s){t.setPostTranslationHandler(s)},get sync(){return t.inheritLocale},set sync(s){t.inheritLocale=s},get warnHtmlInMessage(){return t.warnHtmlMessage?"warn":"off"},set warnHtmlInMessage(s){t.warnHtmlMessage=s!=="off"},get escapeParameterHtml(){return t.escapeParameter},set escapeParameterHtml(s){t.escapeParameter=s},get preserveDirectiveContent(){return!0},set preserveDirectiveContent(s){},get pluralizationRules(){return t.pluralRules||{}},__composer:t,t(...s){const[o,a,l]=s,c={};let u=null,f=null;if(!ve(o))throw Rt(Mt.INVALID_ARGUMENT);const h=o;return ve(a)?c.locale=a:ut(a)?u=a:Oe(a)&&(f=a),ut(l)?u=l:Oe(l)&&(f=l),Reflect.apply(t.t,t,[h,u||f||{},c])},rt(...s){return Reflect.apply(t.rt,t,[...s])},tc(...s){const[o,a,l]=s,c={plural:1};let u=null,f=null;if(!ve(o))throw Rt(Mt.INVALID_ARGUMENT);const h=o;return ve(a)?c.locale=a:St(a)?c.plural=a:ut(a)?u=a:Oe(a)&&(f=a),ve(l)?c.locale=l:ut(l)?u=l:Oe(l)&&(f=l),Reflect.apply(t.t,t,[h,u||f||{},c])},te(s,o){return t.te(s,o)},tm(s){return t.tm(s)},getLocaleMessage(s){return t.getLocaleMessage(s)},setLocaleMessage(s,o){t.setLocaleMessage(s,o)},mergeLocaleMessage(s,o){t.mergeLocaleMessage(s,o)},d(...s){return Reflect.apply(t.d,t,[...s])},getDateTimeFormat(s){return t.getDateTimeFormat(s)},setDateTimeFormat(s,o){t.setDateTimeFormat(s,o)},mergeDateTimeFormat(s,o){t.mergeDateTimeFormat(s,o)},n(...s){return Reflect.apply(t.n,t,[...s])},getNumberFormat(s){return t.getNumberFormat(s)},setNumberFormat(s,o){t.setNumberFormat(s,o)},mergeNumberFormat(s,o){t.mergeNumberFormat(s,o)},getChoiceIndex(s,o){return-1}};return r.__extender=i,r}}const Dc={tag:{type:[String,Object]},locale:{type:String},scope:{type:String,validator:n=>n==="parent"||n==="global",default:"parent"},i18n:{type:Object}};function $A({slots:n},e){return e.length===1&&e[0]==="default"?(n.default?n.default():[]).reduce((i,r)=>[...i,...r.type===pt?r.children:[r]],[]):e.reduce((t,i)=>{const r=n[i];return r&&(t[i]=r()),t},{})}function Jp(n){return pt}const YA=It({name:"i18n-t",props:Pt({keypath:{type:String,required:!0},plural:{type:[Number,String],validator:n=>St(n)||!isNaN(n)}},Dc),setup(n,e){const{slots:t,attrs:i}=e,r=n.i18n||Uc({useScope:n.scope,__useComponent:!0});return()=>{const s=Object.keys(t).filter(f=>f!=="_"),o={};n.locale&&(o.locale=n.locale),n.plural!==void 0&&(o.plural=ve(n.plural)?+n.plural:n.plural);const a=$A(e,s),l=r[Yl](n.keypath,a,o),c=Pt({},i),u=ve(n.tag)||it(n.tag)?n.tag:Jp();return xc(u,c,l)}}}),Ph=YA;function qA(n){return ut(n)&&!ve(n[0])}function Zp(n,e,t,i){const{slots:r,attrs:s}=e;return()=>{const o={part:!0};let a={};n.locale&&(o.locale=n.locale),ve(n.format)?o.key=n.format:it(n.format)&&(ve(n.format.key)&&(o.key=n.format.key),a=Object.keys(n.format).reduce((h,m)=>t.includes(m)?Pt({},h,{[m]:n.format[m]}):h,{}));const l=i(n.value,o,a);let c=[o.key];ut(l)?c=l.map((h,m)=>{const g=r[h.type],x=g?g({[h.type]:h.value,index:m,parts:l}):[h.value];return qA(x)&&(x[0].key=`${h.type}-${m}`),x}):ve(l)&&(c=[l]);const u=Pt({},s),f=ve(n.tag)||it(n.tag)?n.tag:Jp();return xc(f,u,c)}}const jA=It({name:"i18n-n",props:Pt({value:{type:Number,required:!0},format:{type:[String,Object]}},Dc),setup(n,e){const t=n.i18n||Uc({useScope:n.scope,__useComponent:!0});return Zp(n,e,Wp,(...i)=>t[jl](...i))}}),Ih=jA,KA=It({name:"i18n-d",props:Pt({value:{type:[Number,Date],required:!0},format:{type:[String,Object]}},Dc),setup(n,e){const t=n.i18n||Uc({useScope:n.scope,__useComponent:!0});return Zp(n,e,Gp,(...i)=>t[ql](...i))}}),Nh=KA;function JA(n,e){const t=n;if(n.mode==="composition")return t.__getInstance(e)||n.global;{const i=t.__getInstance(e);return i!=null?i.__composer:n.global.__composer}}function ZA(n){const e=o=>{const{instance:a,modifiers:l,value:c}=o;if(!a||!a.$)throw Rt(Mt.UNEXPECTED_ERROR);const u=JA(n,a.$),f=Dh(c);return[Reflect.apply(u.t,u,[...Uh(f)]),u]};return{created:(o,a)=>{const[l,c]=e(a);$o&&n.global===c&&(o.__i18nWatcher=Cr(c.locale,()=>{a.instance&&a.instance.$forceUpdate()})),o.__composer=c,o.textContent=l},unmounted:o=>{$o&&o.__i18nWatcher&&(o.__i18nWatcher(),o.__i18nWatcher=void 0,delete o.__i18nWatcher),o.__composer&&(o.__composer=void 0,delete o.__composer)},beforeUpdate:(o,{value:a})=>{if(o.__composer){const l=o.__composer,c=Dh(a);o.textContent=Reflect.apply(l.t,l,[...Uh(c)])}},getSSRProps:o=>{const[a]=e(o);return{textContent:a}}}}function Dh(n){if(ve(n))return{path:n};if(Oe(n)){if(!("path"in n))throw Rt(Mt.REQUIRED_VALUE,"path");return n}else throw Rt(Mt.INVALID_VALUE)}function Uh(n){const{path:e,locale:t,args:i,choice:r,plural:s}=n,o={},a=i||{};return ve(t)&&(o.locale=t),St(r)&&(o.plural=r),St(s)&&(o.plural=s),[e,a,o]}function QA(n,e,...t){const i=Oe(t[0])?t[0]:{},r=!!i.useI18nComponentName;($e(i.globalInstall)?i.globalInstall:!0)&&([r?"i18n":Ph.name,"I18nT"].forEach(o=>n.component(o,Ph)),[Ih.name,"I18nN"].forEach(o=>n.component(o,Ih)),[Nh.name,"I18nD"].forEach(o=>n.component(o,Nh))),n.directive("t",ZA(e))}function e1(n,e,t){return{beforeCreate(){const i=Nr();if(!i)throw Rt(Mt.UNEXPECTED_ERROR);const r=this.$options;if(r.i18n){const s=r.i18n;if(r.__i18n&&(s.__i18n=r.__i18n),s.__root=e,this===this.$root)this.$i18n=Oh(n,s);else{s.__injectWithOption=!0,s.__extender=t.__vueI18nExtend,this.$i18n=Jl(s);const o=this.$i18n;o.__extender&&(o.__disposer=o.__extender(this.$i18n))}}else if(r.__i18n)if(this===this.$root)this.$i18n=Oh(n,r);else{this.$i18n=Jl({__i18n:r.__i18n,__injectWithOption:!0,__extender:t.__vueI18nExtend,__root:e});const s=this.$i18n;s.__extender&&(s.__disposer=s.__extender(this.$i18n))}else this.$i18n=n;r.__i18nGlobal&&Kp(e,r,r),this.$t=(...s)=>this.$i18n.t(...s),this.$rt=(...s)=>this.$i18n.rt(...s),this.$tc=(...s)=>this.$i18n.tc(...s),this.$te=(s,o)=>this.$i18n.te(s,o),this.$d=(...s)=>this.$i18n.d(...s),this.$n=(...s)=>this.$i18n.n(...s),this.$tm=s=>this.$i18n.tm(s),t.__setInstance(i,this.$i18n)},mounted(){},unmounted(){const i=Nr();if(!i)throw Rt(Mt.UNEXPECTED_ERROR);const r=this.$i18n;delete this.$t,delete this.$rt,delete this.$tc,delete this.$te,delete this.$d,delete this.$n,delete this.$tm,r.__disposer&&(r.__disposer(),delete r.__disposer,delete r.__extender),t.__deleteInstance(i),delete this.$i18n}}}function Oh(n,e){n.locale=e.locale||n.locale,n.fallbackLocale=e.fallbackLocale||n.fallbackLocale,n.missing=e.missing||n.missing,n.silentTranslationWarn=e.silentTranslationWarn||n.silentFallbackWarn,n.silentFallbackWarn=e.silentFallbackWarn||n.silentFallbackWarn,n.formatFallbackMessages=e.formatFallbackMessages||n.formatFallbackMessages,n.postTranslation=e.postTranslation||n.postTranslation,n.warnHtmlInMessage=e.warnHtmlInMessage||n.warnHtmlInMessage,n.escapeParameterHtml=e.escapeParameterHtml||n.escapeParameterHtml,n.sync=e.sync||n.sync,n.__composer[Yp](e.pluralizationRules||n.pluralizationRules);const t=Ea(n.locale,{messages:e.messages,__i18n:e.__i18n});return Object.keys(t).forEach(i=>n.mergeLocaleMessage(i,t[i])),e.datetimeFormats&&Object.keys(e.datetimeFormats).forEach(i=>n.mergeDateTimeFormat(i,e.datetimeFormats[i])),e.numberFormats&&Object.keys(e.numberFormats).forEach(i=>n.mergeNumberFormat(i,e.numberFormats[i])),n}const t1=Li("global-vue-i18n");function n1(n={},e){const t=__VUE_I18N_LEGACY_API__&&$e(n.legacy)?n.legacy:__VUE_I18N_LEGACY_API__,i=$e(n.globalInjection)?n.globalInjection:!0,r=__VUE_I18N_LEGACY_API__&&t?!!n.allowComposition:!0,s=new Map,[o,a]=i1(n,t),l=Li("");function c(h){return s.get(h)||null}function u(h,m){s.set(h,m)}function f(h){s.delete(h)}{const h={get mode(){return __VUE_I18N_LEGACY_API__&&t?"legacy":"composition"},get allowComposition(){return r},async install(m,...g){if(m.__VUE_I18N_SYMBOL__=l,m.provide(m.__VUE_I18N_SYMBOL__,h),Oe(g[0])){const p=g[0];h.__composerExtend=p.__composerExtend,h.__vueI18nExtend=p.__vueI18nExtend}let x=null;!t&&i&&(x=h1(m,h.global)),__VUE_I18N_FULL_INSTALL__&&QA(m,h,...g),__VUE_I18N_LEGACY_API__&&t&&m.mixin(e1(a,a.__composer,h));const _=m.unmount;m.unmount=()=>{x&&x(),h.dispose(),_()}},get global(){return a},dispose(){o.stop()},__instances:s,__getInstance:c,__setInstance:u,__deleteInstance:f};return h}}function Uc(n={}){const e=Nr();if(e==null)throw Rt(Mt.MUST_BE_CALL_SETUP_TOP);if(!e.isCE&&e.appContext.app!=null&&!e.appContext.app.__VUE_I18N_SYMBOL__)throw Rt(Mt.NOT_INSTALLED);const t=r1(e),i=o1(t),r=jp(e),s=s1(n,r);if(__VUE_I18N_LEGACY_API__&&t.mode==="legacy"&&!n.__useComponent){if(!t.allowComposition)throw Rt(Mt.NOT_AVAILABLE_IN_LEGACY_MODE);return u1(e,s,i,n)}if(s==="global")return Kp(i,n,r),i;if(s==="parent"){let l=a1(t,e,n.__useComponent);return l==null&&(l=i),l}const o=t;let a=o.__getInstance(e);if(a==null){const l=Pt({},n);"__i18n"in r&&(l.__i18n=r.__i18n),i&&(l.__root=i),a=Nc(l),o.__composerExtend&&(a[Kl]=o.__composerExtend(a)),c1(o,e,a),o.__setInstance(e,a)}return a}function i1(n,e,t){const i=_m();{const r=__VUE_I18N_LEGACY_API__&&e?i.run(()=>Jl(n)):i.run(()=>Nc(n));if(r==null)throw Rt(Mt.UNEXPECTED_ERROR);return[i,r]}}function r1(n){{const e=cs(n.isCE?t1:n.appContext.app.__VUE_I18N_SYMBOL__);if(!e)throw Rt(n.isCE?Mt.NOT_INSTALLED_WITH_PROVIDE:Mt.UNEXPECTED_ERROR);return e}}function s1(n,e){return ga(n)?"__i18n"in e?"local":"global":n.useScope?n.useScope:"local"}function o1(n){return n.mode==="composition"?n.global:n.global.__composer}function a1(n,e,t=!1){let i=null;const r=e.root;let s=l1(e,t);for(;s!=null;){const o=n;if(n.mode==="composition")i=o.__getInstance(s);else if(__VUE_I18N_LEGACY_API__){const a=o.__getInstance(s);a!=null&&(i=a.__composer,t&&i&&!i[qp]&&(i=null))}if(i!=null||r===s)break;s=s.parent}return i}function l1(n,e=!1){return n==null?null:e&&n.vnode.ctx||n.parent}function c1(n,e,t){ir(()=>{},e),dc(()=>{const i=t;n.__deleteInstance(e);const r=i[Kl];r&&(r(),delete i[Kl])},e)}function u1(n,e,t,i={}){const r=e==="local",s=ld(null);if(r&&n.proxy&&!(n.proxy.$options.i18n||n.proxy.$options.__i18n))throw Rt(Mt.MUST_DEFINE_I18N_OPTION_IN_ALLOW_COMPOSITION);const o=$e(i.inheritLocale)?i.inheritLocale:!ve(i.locale),a=on(!r||o?t.locale.value:ve(i.locale)?i.locale:kr),l=on(!r||o?t.fallbackLocale.value:ve(i.fallbackLocale)||ut(i.fallbackLocale)||Oe(i.fallbackLocale)||i.fallbackLocale===!1?i.fallbackLocale:a.value),c=on(Ea(a.value,i)),u=on(Oe(i.datetimeFormats)?i.datetimeFormats:{[a.value]:{}}),f=on(Oe(i.numberFormats)?i.numberFormats:{[a.value]:{}}),h=r?t.missingWarn:$e(i.missingWarn)||Ai(i.missingWarn)?i.missingWarn:!0,m=r?t.fallbackWarn:$e(i.fallbackWarn)||Ai(i.fallbackWarn)?i.fallbackWarn:!0,g=r?t.fallbackRoot:$e(i.fallbackRoot)?i.fallbackRoot:!0,x=!!i.fallbackFormat,_=ot(i.missing)?i.missing:null,p=ot(i.postTranslation)?i.postTranslation:null,R=r?t.warnHtmlMessage:$e(i.warnHtmlMessage)?i.warnHtmlMessage:!0,v=!!i.escapeParameter,S=r?t.modifiers:Oe(i.modifiers)?i.modifiers:{},P=i.pluralRules||r&&t.pluralRules;function T(){return[a.value,l.value,c.value,u.value,f.value]}const L=Sn({get:()=>s.value?s.value.locale.value:a.value,set:b=>{s.value&&(s.value.locale.value=b),a.value=b}}),D=Sn({get:()=>s.value?s.value.fallbackLocale.value:l.value,set:b=>{s.value&&(s.value.fallbackLocale.value=b),l.value=b}}),M=Sn(()=>s.value?s.value.messages.value:c.value),y=Sn(()=>u.value),V=Sn(()=>f.value);function B(){return s.value?s.value.getPostTranslationHandler():p}function O(b){s.value&&s.value.setPostTranslationHandler(b)}function ee(){return s.value?s.value.getMissingHandler():_}function ne(b){s.value&&s.value.setMissingHandler(b)}function se(b){return T(),b()}function ie(...b){return s.value?se(()=>Reflect.apply(s.value.t,null,[...b])):se(()=>"")}function $(...b){return s.value?Reflect.apply(s.value.rt,null,[...b]):""}function ue(...b){return s.value?se(()=>Reflect.apply(s.value.d,null,[...b])):se(()=>"")}function fe(...b){return s.value?se(()=>Reflect.apply(s.value.n,null,[...b])):se(()=>"")}function ge(b){return s.value?s.value.tm(b):{}}function we(b,k){return s.value?s.value.te(b,k):!1}function qe(b){return s.value?s.value.getLocaleMessage(b):{}}function Q(b,k){s.value&&(s.value.setLocaleMessage(b,k),c.value[b]=k)}function he(b,k){s.value&&s.value.mergeLocaleMessage(b,k)}function me(b){return s.value?s.value.getDateTimeFormat(b):{}}function de(b,k){s.value&&(s.value.setDateTimeFormat(b,k),u.value[b]=k)}function Ue(b,k){s.value&&s.value.mergeDateTimeFormat(b,k)}function Fe(b){return s.value?s.value.getNumberFormat(b):{}}function W(b,k){s.value&&(s.value.setNumberFormat(b,k),f.value[b]=k)}function Ke(b,k){s.value&&s.value.mergeNumberFormat(b,k)}const be={get id(){return s.value?s.value.id:-1},locale:L,fallbackLocale:D,messages:M,datetimeFormats:y,numberFormats:V,get inheritLocale(){return s.value?s.value.inheritLocale:o},set inheritLocale(b){s.value&&(s.value.inheritLocale=b)},get availableLocales(){return s.value?s.value.availableLocales:Object.keys(c.value)},get modifiers(){return s.value?s.value.modifiers:S},get pluralRules(){return s.value?s.value.pluralRules:P},get isGlobal(){return s.value?s.value.isGlobal:!1},get missingWarn(){return s.value?s.value.missingWarn:h},set missingWarn(b){s.value&&(s.value.missingWarn=b)},get fallbackWarn(){return s.value?s.value.fallbackWarn:m},set fallbackWarn(b){s.value&&(s.value.missingWarn=b)},get fallbackRoot(){return s.value?s.value.fallbackRoot:g},set fallbackRoot(b){s.value&&(s.value.fallbackRoot=b)},get fallbackFormat(){return s.value?s.value.fallbackFormat:x},set fallbackFormat(b){s.value&&(s.value.fallbackFormat=b)},get warnHtmlMessage(){return s.value?s.value.warnHtmlMessage:R},set warnHtmlMessage(b){s.value&&(s.value.warnHtmlMessage=b)},get escapeParameter(){return s.value?s.value.escapeParameter:v},set escapeParameter(b){s.value&&(s.value.escapeParameter=b)},t:ie,getPostTranslationHandler:B,setPostTranslationHandler:O,getMissingHandler:ee,setMissingHandler:ne,rt:$,d:ue,n:fe,tm:ge,te:we,getLocaleMessage:qe,setLocaleMessage:Q,mergeLocaleMessage:he,getDateTimeFormat:me,setDateTimeFormat:de,mergeDateTimeFormat:Ue,getNumberFormat:Fe,setNumberFormat:W,mergeNumberFormat:Ke};function I(b){b.locale.value=a.value,b.fallbackLocale.value=l.value,Object.keys(c.value).forEach(k=>{b.mergeLocaleMessage(k,c.value[k])}),Object.keys(u.value).forEach(k=>{b.mergeDateTimeFormat(k,u.value[k])}),Object.keys(f.value).forEach(k=>{b.mergeNumberFormat(k,f.value[k])}),b.escapeParameter=v,b.fallbackFormat=x,b.fallbackRoot=g,b.fallbackWarn=m,b.missingWarn=h,b.warnHtmlMessage=R}return yd(()=>{if(n.proxy==null||n.proxy.$i18n==null)throw Rt(Mt.NOT_AVAILABLE_COMPOSITION_IN_LEGACY);const b=s.value=n.proxy.$i18n.__composer;e==="global"?(a.value=b.locale.value,l.value=b.fallbackLocale.value,c.value=b.messages.value,u.value=b.datetimeFormats.value,f.value=b.numberFormats.value):r&&I(b)}),be}const f1=["locale","fallbackLocale","availableLocales"],Fh=["t","rt","d","n","tm","te"];function h1(n,e){const t=Object.create(null);return f1.forEach(r=>{const s=Object.getOwnPropertyDescriptor(e,r);if(!s)throw Rt(Mt.UNEXPECTED_ERROR);const o=Kt(s.value)?{get(){return s.value.value},set(a){s.value.value=a}}:{get(){return s.get&&s.get()}};Object.defineProperty(t,r,o)}),n.config.globalProperties.$i18n=t,Fh.forEach(r=>{const s=Object.getOwnPropertyDescriptor(e,r);if(!s||!s.value)throw Rt(Mt.UNEXPECTED_ERROR);Object.defineProperty(n.config.globalProperties,`$${r}`,s)}),()=>{delete n.config.globalProperties.$i18n,Fh.forEach(r=>{delete n.config.globalProperties[`$${r}`]})}}VA();__INTLIFY_JIT_COMPILATION__?_h(OA):_h(UA);AA(aA);wA(Np);if(__INTLIFY_PROD_DEVTOOLS__){const n=$n();n.__INTLIFY__=!0,_A(n.__INTLIFY_DEVTOOLS_GLOBAL_HOOK__)}const d1={home:"Welcome",projects:"Projects",about:"About",contacts:"Contacts",menu:"Menu"},p1={based:"BASED IN MOLDOVA",welcome_1:"WELCOME TO",welcome_2:"MY PORTFOLIO 2025",button:"OPEN TO WORK",specialize:"SPECIALIZING IN INTERACTIVE WEB EXPERIENCES"},m1={title:"ABOUT ME",title_desc:"Hi, I'm a 21 year old student from Moldova, beginning my journey in the IT industry. I'm enthusiastic and a quick learner, always open for new experiences and challenges to refine and advance my skills.",exp:"PROFESSIONAL EXPERIENCE",exp_desc:"WHILE WORKING AT TWEENYONE SRL, I DEVELOPED WEBPAGES TO MEET THE REQUESTS OF EACH CLIENT, WHILE ALSO IMPLEMENTING RESPONSIVE DESIGN.",exp_desc2:"AT TRISEIDON SRL, I IMPLEMENTED RESPONSIVE AND MODULAR DESIGN. ALSO CREATED FULL CUSTOM ANIMATED 3D SCENES USING THREE.JS & BLENDER.",education:"EDUCATION",education_web_1:"ADMINISTRATION OF WEB APPLICATIONS",education_web_2:"CENTER OF EXCELLENCE IN ECONOMICS AND FINANCE",education_utm_1:"INFORMATIONAL TECHNOLOGIES",education_utm_2:"TECHNICAL UNIVERSITY OF MOLDOVA",city:"CHISINAU"},_1={selected:"Selected Works",visit:"Visit Site",year:"Year",role:"Role",tehnologies:"Tehnologies"},g1={title:"Skills & Tehnologies",button_show:"Show",button_hide:"Hide",button:"Stack"},v1={title:"LET'S WORK TOGETHER",connect:"CONNECT ON"},x1={nav:d1,header:p1,about:m1,card:_1,stack:g1,footer:v1},E1={home:"Acasă",projects:"Proiecte",about:"Despre",contacts:"Contacte",menu:"Meniu"},S1={based:"SITUAT ÎN MOLDOVA",welcome_1:"BINE AȚI VENIT",welcome_2:"PORTOFOLIUL 2025",button:"DISPONIBIL",specialize:"SPECIALIZAT ÎN EXPERIENȚE WEB INTERACTIVE"},M1={title:"DESPRE MINE",title_desc:"Salut, sunt un student din Moldova și am 21 de ani, și-mi încep călătoria în industria IT. Sunt entuziast și sunt mereu deschis pentru noi experiențe și provocări pentru a-mi perfecționa și avansa abilitățile mele.",exp:"EXPERIENȚĂ PROFESIONALĂ",exp_desc:"Lucrând la Tweenyone SRL, am dezvoltat pagini web pentru a satisface cerințele fiecărui client, implementând în același timp un design responsive.",exp_desc2:"LA TRISEIDON SRL, AM IMPLEMENTAT DESIGN RESPONSIV ȘI MODULAR. DE ASEMENEA, AM CREAT SCENE 3D ANIMATE COMPLET PERSONALIZATE UTILIZÂND THREE.JS ȘI BLENDER.",education:"EDUCAȚIE",education_web_1:"ADMINISTRAREA APLICAȚIILOR WEB",education_web_2:"CENTRU DE EXCELENȚĂ ÎN ECONOMIE ȘI FINANȚE",education_utm_1:"TEHNOLOGII INFORMAȚIONALE",education_utm_2:"UNIVERSITATEA TEHNICĂ A MOLDOVEI",city:"CHIȘINĂU"},y1={selected:"Proiectele selectate",visit:"Vizitează",year:"Anul",role:"Rolul",tehnologies:"Tehnologii"},T1={title:"Abilități & Tehnologii",button_show:"Arată",button_hide:"Ascunde",button:"Stack"},b1={title:"HAI SĂ LUCRĂM ÎMPREUNĂ",connect:"CONNECTEAZĂ-TE"},A1={nav:E1,header:S1,about:M1,card:y1,stack:T1,footer:b1},w1=n1({legacy:!1,locale:"en",messages:{en:x1,ro:A1}});Rg(pb).use(w1).mount("#app");
